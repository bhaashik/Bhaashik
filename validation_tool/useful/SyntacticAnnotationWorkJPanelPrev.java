...
import bhaashik.corpus.simple.impl.SimpleStoryImpl;
import bhaashik.gui.common.DialogFactory;
import bhaashik.gui.common.FileSelectionJPanel;
...
import bhaashik.mlearning.crf.CRFAnnotationMain;
import bhaashik.table.gui.DisplayEvent;
import bhaashik.table.gui.FindEvent;
import bhaashik.table.gui.FindEventListener;
import bhaashik.table.gui.BhaashikActionTableCellEditor;
import bhaashik.table.gui.BhaashikDefaultJTable;
import bhaashik.text.enc.conv.EncodingConverterUtils;
import bhaashik.util.file.FileMonitor;
import bhaashik.util.file.BhaashikBackup;
import bhaashik.util.query.SSFFindReplace;

/**
 *
 * @author  anil
 */
public class SyntacticAnnotationWorkJPanelPrev extends javax.swing.JPanel
        implements WindowListener, WorkJPanelInterface, bhaashik.gui.common.JPanelDialog,
    ...
    protected String charset = bhaashik.GlobalProperties.getIntlString("UTF-8");

    protected String title = bhaashik.GlobalProperties.getIntlString("Untitled");
...
//    private SSFPhraseJPanel ssfPhraseJPanel;
    ...
    protected BhaashikTreeViewerJPanel viewTreeJPanel;

    protected BhaashikBackup bhaashikBackup;
    ...
    public SyntacticAnnotationWorkJPanelPrev() {
        super();
...
//        ssfUTF8Story = new SSFStoryImpl();
    ...
    public SyntacticAnnotationWorkJPanelPrev(KeyValueProperties kvTaskProps) {
        this();
    ...
    public SyntacticAnnotationWorkJPanelPrev(boolean propbankMode) {
        this();
    ...
    public SyntacticAnnotationWorkJPanelPrev(KeyValueProperties kvTaskProps, boolean propbankMode) {
        this(kvTaskProps);
    ...
    private void initComponents() {
        ...
        validationCJButton = new javax.swing.JButton();
        validationOneByOneSimpleJButton = new javax.swing.JButton();
        validationOneByOneJButton = new javax.swing.JButton();
        fifthCommandsJPanel = new javax.swing.JPanel();
        validationJComboBox = new javax.swing.JComboBox();
        ...
        commentJTextArea.setFont(new java.awt.Font("Dialog", 1, 14));
        ...
        firstJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        prevJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        lastJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        resetJButton.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        statJButton.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        saveAsJButton.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        statInFilesJButton.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        clearAllJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        clearJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        resetAllJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        editTextJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        sentenceJoinJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        sentenceSplitJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        findJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        replaceJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        findInFilesJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        replaceInFilesJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        replaceBatchJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        replaceBatchInFilesJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        joinFilesJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        transferTagsJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        setMorphTagsJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        convertEncodingJButton.setFont(new java.awt.Font("Dialog", 0, 11));
        ...
        validationCJButton.setText("Validation");
        validationCJButton.setToolTipText("Validation");
        validationCJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                validationCJButtonActionPerformed(evt);
            }
        });
        fourthCommandsJPanel.add(validationCJButton);

        validationOneByOneSimpleJButton.setText("Validate one by one (1)");
        validationOneByOneSimpleJButton.setToolTipText("Validate one by one (1)");
        validationOneByOneSimpleJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                validationOneByOneSimpleJButtonActionPerformed(evt);
            }
        });
        fourthCommandsJPanel.add(validationOneByOneSimpleJButton);

        validationOneByOneJButton.setText("Validate one by one (2)");
        validationOneByOneJButton.setToolTipText("Validate one by one (2)");
        validationOneByOneJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                validationOneByOneJButtonActionPerformed(evt);
            }
        });
        fourthCommandsJPanel.add(validationOneByOneJButton);

        commandsJPanel.add(fourthCommandsJPanel);

        fifthCommandsJPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        validationJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "POS Tags", "Chunk Tags", "Tree Checks", "Linguistic Checks", "All" }));
        fifthCommandsJPanel.add(validationJComboBox);

        validationJButton.setText("Validate");
        validationJButton.setToolTipText("Validate the annotated data using the selected option");
        fifthCommandsJPanel.add(validationJButton);

        commandsJPanel.add(fifthCommandsJPanel);
...
//            ssfPhraseJPanel.getJPopupMenu().get
            ...
            ssfPhraseJPanel.showCommandButtons(false);
        ...
        else
        {
            ...
            ssfPhraseJPanel.showCommandButtons(true);
...
//            e.printStackTrace();
    ...
    private void validationCJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validationCJButtonActionPerformed
        // TODO add your handling code here:
...
//String cmd = "./run-validation_checks.sh " + inputDirectoryforValidation; // this is the command to execute in the Unix shell
            String cmd = "./validation_tool/val-prev/run-validation_checks.sh ./validation_tool " + inputDirectoryforValidation; // this is the command to execute in the Unix shell
...
//            System.out.println("PATH:"+inputDirectoryforValidation);
            ...
            System.err.print(tic);
                ...
                try {
                    ...
                    Logger.getLogger(SyntacticAnnotationWorkJPanelPrev.class.getName()).log(Level.SEVERE, null, ex);
                }
            int c;
        ...
        BhaashikTableModel tablemodel = new BhaashikTableModel(cells, new String[]{"(1)", "(2)", "(3)", "Comments"});
        showValidationResults(tablemodel, "hin::utf8", 1);
        }
    }//GEN-LAST:event_validationCJButtonActionPerformed

    private void validationOneByOneSimpleJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validationOneByOneSimpleJButtonActionPerformed
        // TODO add your handling code here:
...
//            System.out.println("PATH:"+inputDirectoryforValidation);
        ...
        if(text!=null && !text.equals("")){
            ...
            SyntacticAnnotationWorkJPanelPrev navigatedPanel;

            if (this.owner instanceof bhaashik.BhaashikMain) {

    //            navigatedPanel = new SyntacticAnnotationWorkJPanel(kvTaskProps1);
    //            navigatedPanel.setOwner(this.owner);
    //            ((BhaashikMain) this.owner).addApplicationToTabbedPane(navigatedPanel, "Syntactic Annotation", false);
    ...
    //            navigatedPanel.setCurrentPosition(Integer.parseInt(sentenceId)-1, 0);
                ...
                Vector nodes = this.sentence.getRoot().getNodesForFS("name='"+nodeID+"'");
    ...
    }//GEN-LAST:event_validationOneByOneSimpleJButtonActionPerformed
...
//            System.out.println("PATH:"+inputDirectoryforValidation);
    ...
    private void validationAnilsir()
    {
        // TODO add your handling code here:
        storeCurrentPosition();

        String validationOption = (String) validationJComboBox.getSelectedItem();

        BhaashikTableModel matches = syntacticAnnotationValidator.validate(ssfStory, validationOption);
    ...
    private BhaashikTableModel getValTableModel() {

        String curDir = stateKVProps.getPropertyValue("CurrentDir");

        if(textFile != null && !textFile.equals("") && !textFile.equals(bhaashik.GlobalProperties.getIntlString("Untitled"))) {
...
/*
        ...
        //BhaashikJDialog openDialog = new BhaashikJDialog(owner, "Validation Tool", true, (JPanelDialog) validationJPanel);
*/
     ...
     //   validationToolJPanel.setOwner(this.owner);
        ...
        /*
        BhaashikJDialog fsDialog = (BhaashikJDialog) DialogFactory.showFileSelectionDialog(owner, bhaashik.GlobalProperties.getIntlString("FileSelectionJPanel"), true, new File(curDir));
        ...
        BhaashikJDialog openDialog = new BhaashikJDialog(owner, bhaashik.GlobalProperties.getIntlString("Bhaashik_Syntactic_Annotation_Task_Setup"), true, (JPanelDialog) taskSetupJPanel);
        openDialog.pack();
    ...
    private void validateFiles()
    {
        ...
        //BhaashikTableModel matches = syntacticAnnotationValidator.validate(ssfStory, validationOption);
        BhaashikTableModel matches = getValTableModel();
    ...
    private void validationOneByOneJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validationOneByOneJButtonActionPerformed
        // TODO add your handling code here:
        validateFiles();
    }//GEN-LAST:event_validationOneByOneJButtonActionPerformed

    private void showValidationResults(BhaashikTableModel matches,String langEnc, int tcount) {
...
//        }
        ...
        BhaashikJDialog check = DialogFactory.showTableDialog(dialog, "Validation Results @ " + inputDirforValidation, false, matches, langEnc, BhaashikTableJPanel.DEFAULT_MODE);

        BhaashikTableJPanel tableJpanel = (BhaashikTableJPanel) check.getJPanel();

        BhaashikActionTableCellEditor editor = new BhaashikActionTableCellEditor(this, langEnc, "Sentence", BhaashikActionTableCellEditor.VALIDATION_MODE);
        tableJpanel.getJTable().setDefaultEditor(String.class, editor);
        ((BhaashikDefaultJTable) tableJpanel.getJTable()).addEventListener(this);
    }
    ...
    public void searchinFSandhighlight(SSFNode root, String search, SyntacticAnnotationWorkJPanelPrev navigatedPanel ) {
...
//            try {
//                if(mmRoot == null)
//                    viewTreeJPanel = new BhaashikTreeViewerJPanel(sentence.getRoot(), sentence.getRoot().getCopy(), cfgToMMTreeMapping, BhaashikMutableTreeNode.DEPENDENCY_STRUCTURE_MODE, langEnc, false);
//                else
//                    viewTreeJPanel = new BhaashikTreeViewerJPanel(sentence.getRoot(), mmRoot, cfgToMMTreeMapping, BhaashikMutableTreeNode.DEPENDENCY_STRUCTURE_MODE, langEnc, false);
//            } catch (Exception ex) {
//                ex.printStackTrace();
//            }

                viewTreeJPanel = new BhaashikTreeViewerJPanel((SSFPhrase) sentence.getRoot(), BhaashikMutableTreeNode.CHUNK_MODE, langEnc);

                viewTreeJPanel.setBhaashikTreeJPanel(ssfPhraseJPanel);
                viewTreeJPanel.initPopupMenu();
                dndRightJPanel.removeAll();
                dndRightJPanel.add(viewTreeJPanel, BorderLayout.CENTER);
                String selectinJtable = viewTreeJPanel.getCellPosition((BhaashikMutableTreeNode) ((SSFPhrase) root));
...
//above I added later april
        ...
        for (int i =0; i <len; i++)
        {
            ...
            String fs = node.getFeatureStructures().getAttributeValue("name");
            if(fs.equals(search))
            {
...
//            }
                ...
                BhaashikMutableTreeNode node1 = (BhaashikMutableTreeNode) node;

                String selectinJtable = viewTreeJPanel.getCellPosition(node1);

                System.err.println(selectinJtable+"ting"+node1);

                 BhaashikEdges bhaashikEdges = viewTreeJPanel.getEdges();

                for (int ed = 0; ed < bhaashikEdges.countEdges(); ed++) {
                BhaashikEdge bhaashikEdge = bhaashikEdges.getEdge(ed);
                        if(bhaashikEdge.getStartNode().equals(node1))
                        {
                            int cell[] = bhaashikEdge.getStartCell();
...
//above I added later april
    ...
    private void searchinFSandhighlightSimple(SSFNode root, String search, SyntacticAnnotationWorkJPanelPrev navigatedPanel) {
    ...
    public void navigateToSentenceToValidate(NavigatetoValidateEvent evt) {
        ...
        if (this.owner instanceof BhaashikMain) {

            SyntacticAnnotationWorkJPanelPrev navigatedPanel = new SyntacticAnnotationWorkJPanelPrev(kvTaskProps1);
            navigatedPanel.setOwner(this.owner);

            ((BhaashikMain) this.owner).addApplicationToTabbedPane(navigatedPanel, "Syntactic Annotation", false);
            navigatedPanel.configure();
            navigatedPanel.setCurrentPosition(Integer.parseInt(sentenceId)-1, 0);
            Vector nodes = navigatedPanel.sentence.getRoot().getNodesForFS("name='"+nodeID+"'");
    ...
    public void openTaskMode()
    {
        ...
        BhaashikJDialog dialog = new BhaashikJDialog(owner, "Bhaashik Syntactic Annotation Task Setup", true, (JPanelDialog) selectTaskJPanel);
	dialog.pack();
...
//        int ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Are_you_sure_you_want_to_shift_to_the_frameset_mode?"), bhaashik.GlobalProperties.getIntlString("Frameset_Mode"), JOptionPane.YES_NO_OPTION);
//
...
//            return;
        ...
        {
            int ret = JOptionPane.showConfirmDialog(this, "Would you like to save the document before proceeding?", bhaashik.GlobalProperties.getIntlString("Save?"), JOptionPane.YES_NO_OPTION);
...
//        initNavigationList();
        ...
        for(int i = 0; i < count; i++) {
            ...
            Vector nodesTag = root.getNodesForName(extraInfoJPanel.getNavigationTag());
            Vector nodesStem = root.getNodesForAttribVal("lex", extraInfoJPanel.getNavigationWord(), true);
...
//        ssfStory.clearHighlights();
        ...
        if(matches == null)
        {
            JOptionPane.showMessageDialog(this, bhaashik.GlobalProperties.getIntlString("No_match_found."), bhaashik.GlobalProperties.getIntlString("Search_Results"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private BhaashikTableModel queryInFiles(SSFQuery ssfQuery)
    {
        BhaashikTableModel matches = null;
    ...
    private void showSearchResults(BhaashikTableModel matches, String langEnc, int tcount) {
        ...
        matches.setValueAt(bhaashik.GlobalProperties.getIntlString("Total_:_"), 0, 0);
        matches.setValueAt(Integer.toString(tcount), 0, 1);
        
        BhaashikJDialog resultsJDialog = null;

        if(owner != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, bhaashik.GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, BhaashikTableJPanel.DEFAULT_MODE);
        else if(dialog != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, bhaashik.GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, BhaashikTableJPanel.DEFAULT_MODE);

        BhaashikTableJPanel resultsJPanel = (BhaashikTableJPanel) resultsJDialog.getJPanel();

        resultsJPanel.getJTable().getColumnModel().getColumn(0).setCellEditor(new BhaashikActionTableCellEditor(this, langEnc, "Search Results", BhaashikActionTableCellEditor.FIND_AND_NAVIGATE));

        if(tcount > 1)
            resultsJPanel.getJTable().getColumnModel().getColumn(matches.getColumnCount() - 1).setCellEditor(new BhaashikActionTableCellEditor(this, langEnc, "Search Results", BhaashikActionTableCellEditor.FIND_AND_NAVIGATE));

        UtilityFunctions.fitColumnsToContent(resultsJPanel.getJTable());

        ((BhaashikDefaultJTable) resultsJPanel.getJTable()).addEventListener(this);
    }
    ...
    public BhaashikTableModel getFindOptionsTable()
    {
        BhaashikTableModel findOptionsTable = new BhaashikTableModel(0, 4);
        ...
        TableColumn tagsCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("Tag"));
        ...
        TableColumn textCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("Text"));
        ...
        TableColumn attribNamesCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("Attribute_Name"));
        ...
        TableColumn attribValsCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("Attribute_Value"));
        attribValEditor.setEditable(true);
        attribValsCol.setCellEditor(new DefaultCellEditor(attribValEditor));

        BhaashikJDialog findDialog = new BhaashikJDialog(owner, bhaashik.GlobalProperties.getIntlString("Find"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
    ...
    public BhaashikTableModel getReplaceOptionsTable()
    {
        BhaashikTableModel findOptionsTable = new BhaashikTableModel(0, 8);

        BhaashikTableJPanel findOptionsJPanel = BhaashikTableJPanel.createFindOptionsTableJPanel(findOptionsTable, langEnc, true);
        ...
        TableColumn newTagsCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("New_Tag"));
        ...
        TableColumn newTextCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("New_Text"));
        ...
        TableColumn newAttribNamesCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("New_Name"));
        ...
        TableColumn createAttribCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("Create_Attribute"));
        ...
        TableColumn newAttribValsCol = tableJTable.getColumn(bhaashik.GlobalProperties.getIntlString("New_Value"));
        newAttribValsCol.setCellEditor(new DefaultCellEditor(attribValEditor));

        BhaashikJDialog findDialog = new BhaashikJDialog(owner, bhaashik.GlobalProperties.getIntlString("Replace"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
...
//        String val = "";
//
//        BhaashikTableModel findOptionsTable = getFindOptionsTable();
//
...
//        }
//
//        BhaashikTableModel batchMatches = null;
//
...
//
//            matches.insertRow(0);
//            matches.setValueAt(bhaashik.GlobalProperties.getIntlString("Matches_-_") + (i + 1), 0, 0);
//
//            if(matches.getRowCount() > 1)
//                matches.insertRow(1);
//
...
//            batchMatches = BhaashikTableModel.mergeRows(matchesVec);
//
...
//    }
    ...
    public void find(ActionEvent e, boolean inFiles)
    {
        ...
        BhaashikTableModel findOptionsTable = findReplaceTable.getFindOptionsTable();
...
//        showSearchResults(batchMatches, langEnc, 1);
    ...
    public void replace(ActionEvent e, boolean inFiles)
    {
        ...
        BhaashikTableModel findOptionsTable = getReplaceOptionsTable();
...
//            BhaashikTableModel matches = find(ssfStory, nlabel, ntext, attrib, val,
//                    nlabelReplace, ntextReplace, attribReplace, valReplace, true, createAttrib);
    ...
    private BhaashikTableModel find(SSFStory story, String nlabel, String ntext, String attrib, String val,
        ...
        for (int i = 0; i < count; i++) {
            ...
            Vector senNodes = null;
            Vector senNodesForLabel = null;
...
//                senNodesForText = root.getNodesForLexData(ntext);
                ...
                {
                    senNodes = (Vector) UtilityFunctions.getIntersection(senNodes, senNodesForText);
                }
            ...
            if(attrib.equals("[.]*") == false && val.equals("[.]*"))
            {
                ...
                {
                    senNodes = (Vector) UtilityFunctions.getIntersection(senNodes, senNodesForAttrib);
                }
            ...
            if(val.equals("[.]*") == false)
            {
                ...
                {
                    senNodes = (Vector) UtilityFunctions.getIntersection(senNodes, senNodesForVal);
                }
...
//                    cells[i][2] = ((SSFNode) n.getParent()).convertToBracketForm(1);
        ...
        BhaashikTableModel matches = new BhaashikTableModel(cells, new String[] {bhaashik.GlobalProperties.getIntlString("Sentence"), bhaashik.GlobalProperties.getIntlString("Matched_Text"), bhaashik.GlobalProperties.getIntlString("Context")});
    ...
    private BhaashikTableModel findInFiles(String nlabel, String ntext, String attrib, String val,
            String nlabelReplace, String ntextReplace, String attribReplace, String valReplace, boolean replace, boolean createAttrib) {
        BhaashikTableModel matches = null;
        ...
        if(selFiles != null && selFiles.length > 1)
        {
            ...
            for (int i = 0; i < selFiles.length; i++) {
                ...
                if(i == 0) {
                    ...
                    matches.addColumn(bhaashik.GlobalProperties.getIntlString("File"));
                ...
                {
                    BhaashikTableModel fileMatches = null;
    ...
    private BhaashikTableModel getStats(SSFStory story) {
        ...
        BhaashikTableModel matches = new BhaashikTableModel(cells, new String[] {bhaashik.GlobalProperties.getIntlString("Sentences"), bhaashik.GlobalProperties.getIntlString("Chunks"), bhaashik.GlobalProperties.getIntlString("Words"), bhaashik.GlobalProperties.getIntlString("Characters")});
    ...
    private BhaashikTableModel getStatsInFiles() {
        BhaashikTableModel matches = null;
        ...
        if(selFiles != null && selFiles.length > 1) {
            ...
            for (int i = 0; i < selFiles.length; i++) {
                ...
                if(i == 0) {
                    ...
                    BhaashikTableModel fileMatches = getStats(story);
            ...
            matches.setValueAt(bhaashik.GlobalProperties.getIntlString("Total_(All_Files)"), 0, 4);
        } else {
...
//        owner.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    public boolean editSSFText(boolean validateBeforeSave) {
        ...
        JDialog editTextDialog = new JDialog(this.getOwner(), bhaashik.GlobalProperties.getIntlString("Edit_Text"), true);
        
        textFile = kvTaskProps.getPropertyValue("SSFCorpusStoryFile");
        charset = kvTaskProps.getPropertyValue("SSFCorpusCharset");
        
        if(SimpleStoryImpl.getCorpusType(textFile, bhaashik.GlobalProperties.getIntlString("UTF-8")) == CorpusType.RAW
                && (BhaashikLanguages.getLanguageCodeFromLECode(langEnc).equals("urd") == false
                && BhaashikLanguages.getLanguageCodeFromLECode(langEnc).equals("kas") == false)) {
            File tmpFile = new File(textFile + bhaashik.GlobalProperties.getIntlString(".tmp"));

            tmpFile.delete();
            
            try {
                UtilityFunctions.naiivePreprocessing(textFile, charset, tmpFile.getAbsolutePath(), charset, bhaashik.GlobalProperties.getIntlString("hin::utf8"));
...
//	editTextJPanel.setMode(TextEditorJPanel.MINIMAL_MODE);
    ...
    {
//        BhaashikTableModel matches = getStats(ssfStory);
//
//        showSearchResults(matches, langEnc, 1);
    ...
    public void joinSentence(ActionEvent e)
    {
        if(currentPosition == ssfStory.countSentences() - 1) {
            JOptionPane.showMessageDialog(this, bhaashik.GlobalProperties.getIntlString("A_sentence_can_only_be_joined_with_the_next_sentence._You_are_at_the_last_sentence."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        currentComment = currentComment + bhaashik.GlobalProperties.getIntlString("._") + nextComment;
    ...
    public void splitSentence(ActionEvent e)
    {
        ...
        if (currentSelection != null)
        {
            ...
            if((currentNode.getParent() != null && currentNode.getParent().getParent() == null) == false) {
                JOptionPane.showMessageDialog(this, bhaashik.GlobalProperties.getIntlString("Wrong_selection_for_splitting_a_sentence."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
                return;
            }
...
//            save(null);
    ...
    public void joinFiles(ActionEvent e)
    {
        ...
        if(selFiles != null && selFiles.length > 1) {
            ...
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Please_select_more_than_one_files_to_be_joined."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
        }
        ...
        try {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                String scharset = JOptionPane.showInputDialog(this, bhaashik.GlobalProperties.getIntlString("Please_enter_the_charset:"), bhaashik.GlobalProperties.getIntlString("UTF-8"));
                
                ((SSFStoryImpl) joinedStory).save(joinedStoryFile, scharset);
            }
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Error_saving_the_joined_file."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        JOptionPane.showMessageDialog(parentComponent, selFiles.length + 
                "files joined into one file:\n" + joinedStoryFile, bhaashik.GlobalProperties.getIntlString("Joined_Files"), JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void transferTags(ActionEvent e)
    {
        JOptionPane.showMessageDialog(parentComponent, "The number of source and target files and of the sentences\n"
                ...
                + "there may be data loss.", bhaashik.GlobalProperties.getIntlString("Caution"), JOptionPane.INFORMATION_MESSAGE);
        
        Cursor cursor = owner.getCursor();
        owner.setCursor(Cursor.WAIT_CURSOR);
        
        Object srcFiles[] = getSelectedFiles();
        
        Object tgtFiles[] = getSelectedFiles();
        
        if(srcFiles.length != tgtFiles.length) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("The_number_of_source_and_target_files_and_of_the_sentences_and_the_words_in_them_should_be_the_same."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Are_you_sure_you_want_to_clear_some_annotation_this_sentence?"), bhaashik.GlobalProperties.getIntlString("Clear_Annotation_in_Sentence?"), JOptionPane.YES_NO_OPTION);
        ...
        if(owner != null)
            alDialog = SSFAnnotationLevelsJPanel.showDialog(owner, bhaashik.GlobalProperties.getIntlString("SSF_Annotation_Levels"), true);
        else if(dialog != null)
            alDialog = SSFAnnotationLevelsJPanel.showDialog(dialog, bhaashik.GlobalProperties.getIntlString("SSF_Annotation_Levels"), true);
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Are_you_sure_you_want_to_clear_some_annotation_this_task?"), bhaashik.GlobalProperties.getIntlString("Clear_Annotation_in_Task?"), JOptionPane.YES_NO_OPTION);
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Are_you_sure_you_want_to_reset_everything?"), bhaashik.GlobalProperties.getIntlString("Reset_All"), JOptionPane.YES_NO_OPTION);
    ...
    public void configure(SSFStory story)
    {
        ...
        try {
            ...
            fsProps.read(fsm, fso, fsp, fsps, fsd, fss, bhaashik.GlobalProperties.getIntlString("UTF-8"));
            ssfProps.read(ssfp, bhaashik.GlobalProperties.getIntlString("UTF-8"));
            ...
            if(dialog != null)
            {
                dialog.setTitle(bhaashik.GlobalProperties.getIntlString("Bhaashik:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
            else if(owner != null)
            {
                owner.setTitle(bhaashik.GlobalProperties.getIntlString("Bhaashik:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
...
//            ssfUTF8Story.readFile(storyUTF8, ssfProps, fsProps)
            ...
            if(bhaashikBackup != null)
                FileMonitor.getInstance().removeFileChangeListener(bhaashikBackup, textFile);

            bhaashikBackup = new BhaashikBackup();
            FileMonitor.getInstance().addFileChangeListener(bhaashikBackup, textFile, backupPeriod);
            ...
            if(senCount > 0) {
                ...
                ssfPhraseJPanel = BhaashikTreeJPanel.createSSFPhraseJPanel(ssfStory.getSentence(0).getRoot(), phraseNamesPT, posTagsPT, langEnc);
...
//                topJPanel.add(ssfPhraseJPanel, java.awt.BorderLayout.CENTER);
                ...
                if(commentsFile.exists()) {
                    try {
                        commentsPT = new PropertyTokens(commentsFile.getAbsolutePath(), bhaashik.GlobalProperties.getIntlString("UTF-8"));
                ...
                JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Error_in_task_properties_for_the_task:_") + taskName + bhaashik.GlobalProperties.getIntlString("._Unable_to_load_any_sentences."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            }
        } catch(Exception e) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Error_in_task_properties_for_the_task:_") + taskName, bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
...
//            taskList = owner.getTaskList();
            ...
            Vector rows = taskList.getRows(bhaashik.GlobalProperties.getIntlString("TaskName"), taskName);
            
            if(rows.size() != 1) {
                JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Not_a_valid_task_name:_") + taskName, bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
        ...
        try {
            ...
            if(SimpleStoryImpl.getCorpusType(textFile, bhaashik.GlobalProperties.getIntlString("UTF-8")) == CorpusType.RAW) {
                JOptionPane.showMessageDialog(parentComponent, "The task you have selected contains raw text. You\nnow have to make sure that each sentence is on\na separate line to ensure correct annotation.", bhaashik.GlobalProperties.getIntlString("Raw_Text"), JOptionPane.INFORMATION_MESSAGE);
                
                editSSFText(false);
                
                if(langEnc.equals("hin::utf8")) {
                    int ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Would_like_the_text_to_be_POS_tagged?"), bhaashik.GlobalProperties.getIntlString("Perform_POS_Tagging?"), JOptionPane.YES_NO_OPTION);
                    
                    if(ret == JOptionPane.YES_OPTION)
                        annotate(MLCorpusConverter.TAG_FORMAT);
                    
                    ret = JOptionPane.showConfirmDialog(this, bhaashik.GlobalProperties.getIntlString("Would_like_the_text_to_be_chunked?"), bhaashik.GlobalProperties.getIntlString("Perform_Chunking?"), JOptionPane.YES_NO_OPTION);
    ...
    public void save(ActionEvent e) {
                ...
                || (!propbankMode && GlobalProperties.getClientModes().getPropertyValue("SYNTACTIC_ANNOTATION").equals("TASK_MODE")))
        {
            if(SelectTaskJPanel.isOwnTask(taskList, taskName) == false)
            {
                ...
                {
                    JOptionPane.showMessageDialog(parentComponent, "You can save this task only if you have claimed it first.", bhaashik.GlobalProperties.getIntlString("Error"),
        ...
        try {
            ...
            commentsPT.save(kvTaskProps.getPropertyValue("TaskPropFile") + ".comments", bhaashik.GlobalProperties.getIntlString("UTF-8"));

            BhaashikBackup.backup(kvTaskProps.getPropertyValue("SSFCorpusStoryFile"));
            ...
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Error_while_saving."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
...
//        dialog.setVisible(false);
    ...
    public void saveAs(ActionEvent e)
    {
        if(propbankMode)
        {
            JOptionPane.showMessageDialog(parentComponent, "Not available in the task mode.", bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        CorpusType selectedCorpusType = (CorpusType) JOptionPane.showInputDialog(this,
                bhaashik.GlobalProperties.getIntlString("Select_corpus_type_for_saving"), bhaashik.GlobalProperties.getIntlString("Corpus_Type"), JOptionPane.INFORMATION_MESSAGE, null,
    ...
    public void saveAs(CorpusType ctype) {
        ...
        if(textFileAs != null && !textFileAs.equals("") && !textFileAs.equals(bhaashik.GlobalProperties.getIntlString("Untitled"))) {
        ...
        else if(ctype.equals(CorpusType.SSF_TAGGED))
        {
        ...
        else if(ctype.equals(CorpusType.XML_TAGGED)) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("XML_corpus_type_not_yet_implemented."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
        }        
    }
    ...
    public String saveSSFAs(String curDir) {
        ...
        try {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                String charset = JOptionPane.showInputDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Please_enter_the_charset:"), bhaashik.GlobalProperties.getIntlString("UTF-8"));
                
                ((SSFStoryImpl) ssfStory).save(storyFile, charset);
            }
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Error_resetting_from_file._Perhaps_the_file_name_and_the_charset_are_not_defined."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    public String saveBracketFormAs(String curDir) {
        ...
        try {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                String spaces = JOptionPane.showInputDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Please_enter_the_number_of_spaces_after_the_chunk_end:"), "5");
    ...
    protected void openInit(String path, String langEnc)
    {
        ...
        kvTaskProps.addProperty("TaskPropCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("SSFPropFile", GlobalProperties.resolveRelativePath("props/ssf-props.txt"));
        kvTaskProps.addProperty("SSFPropCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("FSPropFile", GlobalProperties.resolveRelativePath("props/fs-props.txt"));
        kvTaskProps.addProperty("FSPropCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("MFeaturesFile", GlobalProperties.resolveRelativePath("props/fs-mandatory-attribs.txt"));
        kvTaskProps.addProperty("MFeaturesCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));
        ...
        kvTaskProps.addProperty("POSTagsCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));

        kvTaskProps.addProperty("PhraseNamesFile", GlobalProperties.resolveRelativePath("workspace/syn-annotation/phrase-names.txt"));
        kvTaskProps.addProperty("PhraseNamesCharset", bhaashik.GlobalProperties.getIntlString("UTF-8"));
    ...
    public BhaashikTreeJPanel getBhaashikTreeJPanel() {
    ...
    public void annotate(int type) {
        ...
        if(baseDir == null || baseDir.equals("") || (new File(baseDir)).exists() == false) {
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Path_given_for_the_training_model_doesn't_exist"), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            owner.setCursor(cursor);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("Please_either_load_a_trained_model_or_train_a_new_model."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            owner.setCursor(cursor);
        }
        
        annotationMain.setMLTrainPath(baseDir + "/" + "crf-train.txt");
        annotationMain.setMLTestPath(baseDir + bhaashik.GlobalProperties.getIntlString("/") + "crf-test.txt");
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(bhaashik.GlobalProperties.getIntlString("Bhaashik_Syntactic_Annotation"));
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
//        JDialog taskDialog = new JDialog(frame, bhaashik.GlobalProperties.getIntlString("Task_Panel"), true);
//
...
//        KeyValueProperties taskKVP = taskJPanel.getTaskProps();
        ...
        SyntacticAnnotationWorkJPanelPrev newContentPane = null;
        
//        newContentPane = new SyntacticAnnotationWorkJPanel(taskKVP);
        newContentPane = new SyntacticAnnotationWorkJPanelPrev();
...
//        newContentPane.configure();
    ...
    private static void saveState(SyntacticAnnotationWorkJPanelPrev editorInstance) {
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.SYNTACTIC_ANNOTATION.toString());
        ...
        if(currentFontSize == null)
            currentFontSize = "" + BhaashikLanguages.getDefaultLangEncFont(editorInstance.getLangEnc()).getSize();
    ...
    private static void loadState(SyntacticAnnotationWorkJPanelPrev editorInstance) {
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.SYNTACTIC_ANNOTATION.toString());
        ...
        if(langEnc == null) {
            langEnc = bhaashik.GlobalProperties.getIntlString("hin::utf8");
            stateKVProps.addProperty("LangEnc", langEnc);
        }

        if(currentFontSize == null)
            stateKVProps.addProperty("CurrentFontSize", ""  + BhaashikLanguages.getDefaultLangEncFont(editorInstance.getLangEnc()).getSize());
    }
    ...
    public void findAndNavigate(FindEvent evt) {
        if(evt.getFilePath() == null || evt.getCharset() == null)
            setCurrentPosition(evt.getSentenceID(), 0);
    ...
    public void displayFile(EventObject e)
    {
        ...
        else if(e instanceof BhaashikMainEvent)
        {
            BhaashikMainEvent sme = (BhaashikMainEvent) e;
    ...
    private class FindOptionsTableChangeListener implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            BhaashikTableModel model = (BhaashikTableModel)e.getSource();
            ...
            if(e.getType() == TableModelEvent.INSERT)
            {
                for (int i = 0; i < ccount; i++)
                {
                    ...
                    if(colName.equals(bhaashik.GlobalProperties.getIntlString("Create_Attribute")))
                        model.setValueAt(new Boolean(false), row, i);
                    else if(colName.equals(bhaashik.GlobalProperties.getIntlString("Tag")))
                        model.setValueAt(tag, row, i);
                    else if(colName.equals(bhaashik.GlobalProperties.getIntlString("Text")))
                    ...
                    if(replace)
                    {
                        if(colName.equals(bhaashik.GlobalProperties.getIntlString("New_Tag")))
                            model.setValueAt(UtilityFunctions.backFromExactMatchRegex(tag), row, i);
                        else if(colName.equals(bhaashik.GlobalProperties.getIntlString("New_Text")))
            ...
            else if(e.getType() == TableModelEvent.UPDATE && replace)
            {
                ...
                if(colName.equals(bhaashik.GlobalProperties.getIntlString("Tag")))
                {
                    tag = (String) model.getValueAt(row, column);
                    int newTagColIndex = model.getColumnIndex(bhaashik.GlobalProperties.getIntlString("New_Tag"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(tag), row, newTagColIndex);
                }
                else if(colName.equals(bhaashik.GlobalProperties.getIntlString("Text")))
                {
                    text = (String) model.getValueAt(row, column);
                    int newTextColIndex = model.getColumnIndex(bhaashik.GlobalProperties.getIntlString("New_Text"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(text), row, newTextColIndex);
                }
                else if(colName.equals(bhaashik.GlobalProperties.getIntlString("Attribute_Name")))
                {
                    String attrib = (String) model.getValueAt(row, column);
                    int newAttribColIndex = model.getColumnIndex(bhaashik.GlobalProperties.getIntlString("New_Name"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(attrib), row, newAttribColIndex);
                }
                else if(colName.equals(bhaashik.GlobalProperties.getIntlString("Attribute_Value")))
                {
                    String val = (String) model.getValueAt(row, column);
                    int newValColIndex = model.getColumnIndex(bhaashik.GlobalProperties.getIntlString("New_Value"));
    ...
    public javax.swing.JPanel fifthCommandsJPanel;
    ...
    public javax.swing.JButton validationCJButton;
    public javax.swing.JButton validationJButton;
    public javax.swing.JComboBox validationJComboBox;
    public javax.swing.JButton validationOneByOneJButton;
    public javax.swing.JButton validationOneByOneSimpleJButton;
