...
import bhaashik.gui.common.RemoteFileExplorerJPanel;
...
import bhaashik.server.dto.model.files.RemoteSftpFile;
 ...
 * @author User
 */
public class BhaashikRemoteWorkJPanel extends javax.swing.JPanel
        implements WindowListener, FileDisplayer, BhaashikClient , JPanelDialog
{
    ...
    private BhaashikSpringRestClient bhaashikSpringRestClient;
    private BhaashikAnnotationManagementUpdateInfo annotationManagementUpdateInfo;
    private BhaashikUserDTO currentUser;

    private BhaashikServerLauncherRI bhaashikServerLauncher;

    private AuthenticationEntryRI authenticationEntry;

    private BhaashikLauncherSessionRI bhaashikLauncherSession;
    private AuthenticationSessionRI authenticationSession;
    
    private UUID launcherSessionId;
    private UUID authenticationSessionId;

    private BhaashikMainServer bhaashikMainServer;
...
//    ShellConnectionStream connectionStream;
     ...
     */
//    public BhaashikSSHClientJPanel(UserManagerServerRI umri, String un) {
    public BhaashikRemoteWorkJPanel() {
        initComponents();
        ...
        try {
            bhaashikSpringRestClient = BhaashikSpringClientUtils.getBhaashikSpringRestClientInstance();
            
            annotationManagementUpdateInfo = BhaashikAnnotationManagementUpdateInfo.builder().build();
        } catch (IOException e) {
...
//            userJTextField.setText(un);
            ...
            Logger.getLogger(BhaashikRemoteWorkJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            taskPath = rootRemoteFileNode.getRemoteRMIFile().getRelativePath();
    ...
    private void organisationsListJListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_organisationsListJListValueChanged
        ...
        if(orgDetails != null)
        {
            ...
            Map<String, BhaashikOrganisationDTO> bhaashikOrganisationMap = null;
//            try {
                bhaashikOrganisationMap = annotationManagementUpdateInfo.getAllOrganisations();
//            } catch (JsonProcessingException e) {
//                throw new RuntimeException(e);
//            }

            BhaashikOrganisationDTO bhaashikOrganisation = bhaashikOrganisationMap.get(orgShortName);

            organisationShortNameJTextField.setText(bhaashikOrganisation.getName());
            organisationLongNameJTextField.setText(bhaashikOrganisation.getLongName());
        }
    ...
    private void languagesListJListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_languagesListJListValueChanged
        ...
        {
            Map<String, BhaashikResourceLanguageDTO> languageMap = null;
//            try {
//                languageMap = bhaashikSpringRestClient.getAllLanguages();
                languageMap = annotationManagementUpdateInfo.getAllLanguages();
//            } catch (JsonProcessingException e) {
//                throw new RuntimeException(e);
//            }

            BhaashikResourceLanguageDTO bhaashikResourceLanguage = languageMap.get(languageName);

            languageNameJTextField.setText(bhaashikResourceLanguage.getName());
        }
    ...
    private void usersListJListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_usersListJListValueChanged
        ...
        if(usersListJList.getSelectedValue() != null)
        {
            ...
            {
                Map<String, BhaashikUserDTO> userMap = null;
//                try {
//                    userMap = bhaashikSpringRestClient.getAllUsers();
                    userMap = annotationManagementUpdateInfo.getAllUsers();
//                } catch (JsonProcessingException e) {
//                    throw new RuntimeException(e);
//                }

                BhaashikUserDTO bhaashikUser = userMap.get(username);

                if(bhaashikUser != null) {
                    usernameJTextField.setText(bhaashikUser.getUsername());
                    passwordJTextField1.setText("");
                    emailJTextField.setText(bhaashikUser.getEmailAddress());
                    firstNameJTextField.setText(bhaashikUser.getFirstName());
                    lastNameJTextField.setText(bhaashikUser.getLastName());
                }
            }
        }
...
//        BhaashikUserDTO selectedUser = bhaashikSpringRestClient.getUser(username);
        BhaashikUserDTO selectedUser = annotationManagementUpdateInfo.getAllUsers().get(username);
    ...
    private void createOrganisationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createOrganisationJButtonActionPerformed
        ...
        if(shortName != null && !shortName.equals("") && longName != null && !longName.equals(""))
        {
            ...
            if(!listModel.contains(orgDetails))
            {
                ...
                BhaashikOrganisationDTO organisationDTO = BhaashikOrganisationDTO.builder().name(shortName).longName(longName).build();
                BhaashikOrganisationSlimDTO organisationSlimDTO = BhaashikOrganisationSlimDTO.builder().name(shortName).longName(longName).build();
//                organisationDTO.setSlimDTO(organisationSlimDTO);
    ...
    private void deleteOrganisationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteOrganisationJButtonActionPerformed
        ...
        if(organisationsListJList.getSelectedValue() != null)
        {
            ...
            BhaashikOrganisationDTO selectedOrganisation = annotationManagementUpdateInfo.getAllOrganisations().get(shortName);
            selectedOrganisation.setDirty(true);
            selectedOrganisation.setToBeDeleted(true);

            BhaashikOrganisationSlimDTO selectedSlimOrganisation = annotationManagementUpdateInfo.getAllSlimOrganisations().get(shortName);
    ...
    private void createLanguageJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createLanguageJButtonActionPerformed
        ...
        if(name != null && !name.equals(""))
        {
            ...
            if(!listModel.contains(name))
            {
                ...
                BhaashikResourceLanguageDTO languageDTO = BhaashikResourceLanguageDTO.builder().name(name).build();
                BhaashikResourceLanguageSlimDTO languageSlimDTO = BhaashikResourceLanguageSlimDTO.builder().name(name).build();
//                languageDTO.setSlimDTO(languageSlimDTO);
    ...
    private void deleteLanguageJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteLanguageJButtonActionPerformed
        ...
        if(languagesListJList.getSelectedValue() != null)
        {
            ...
            BhaashikResourceLanguageDTO languageDTO = annotationManagementUpdateInfo.getAllLanguages().get(name);
            BhaashikResourceLanguageSlimDTO languageSlimDTO = annotationManagementUpdateInfo.getAllSlimLanguages().get(name);
    ...
    private void deleteUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteUserJButtonActionPerformed
        ...
        if(usersListJList.getSelectedValue() != null)
        {
            ...
            if(username != null && username.equals("") == false)
            {
                ...
                BhaashikUserDTO userDTO = annotationManagementUpdateInfo.getAllUsers().get(username);
                BhaashikUserSlimDTO userSlimDTO = annotationManagementUpdateInfo.getAllSlimUsers().get(username);
    ...
    private void addRoleJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRoleJButtonActionPerformed
        ...
        if(name != null)
        {
            ...
            if(!listModel.contains(name))
            {
                ...
                BhaashikRoleDTO roleDTO = annotationManagementUpdateInfo.getAllRoles().get(name);
//                BhaashikRoleSlimDTO roleSlimDTO = annotationManagementUpdateInfo.getAllSlimRoles().get(name);
                
                userDTO.addRole(roleDTO);
//                userDTO.addRole(roleSlimDTO);
//                userDTO.setDirty(true);
//                userDTO.addRole(bhaashikSpringRestClient.getModelMapper().map(roleDTO, BhaashikRoleSlimDTO.class));
//                userDTO.addRole(roleDTO);
            }
        }
...
//            userDTO.removeRole(bhaashikSpringRestClient.getModelMapper().map(roleDTO, BhaashikRoleSlimDTO.class));
        }        
...
//                userDTO.addLanguage(bhaashikSpringRestClient.getModelMapper().map(languageDTO, BhaashikResourceLanguageSlimDTO.class));
            }
        }
...
//            userDTO.removeLanguage(bhaashikSpringRestClient.getModelMapper().map(languageDTO, BhaashikResourceLanguageSlimDTO.class));
        }
...
//                BhaashikOrganisationSlimDTO organisationSlimDTO = annotationManagementUpdateInfo.getAllSlimOrganisations().get(shortName);
                BhaashikOrganisationDTO organisationDTO = annotationManagementUpdateInfo.getAllOrganisations().get(shortName);

                userDTO.addOrganisation(organisationDTO);
//                userDTO.addOrganisation(organisationSlimDTO);
//                userDTO.addOrganisation(bhaashikSpringRestClient.getModelMapper().map(organisationDTO, BhaashikOrganisationSlimDTO.class));
            }
        }
...
//            userDTO.removeOrganisation(bhaashikSpringRestClient.getModelMapper().map(organisationDTO, BhaashikOrganisationSlimDTO.class));
        }
    ...
    private void addAnnotationLevelsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAnnotationLevelsJButtonActionPerformed
        ...
        {            
            ...
            if(!listModel.contains(name))
            {
                ...
                BhaashikAnnotationLevelDTO levelDTO = annotationManagementUpdateInfo.getAllLevels().get(name);
//                BhaashikAnnotationLevelSlimDTO levelSlimDTO = annotationManagementUpdateInfo.getAllSlimLevels().get(name);

                userDTO.addAnnotationLevel(levelDTO);
//                userDTO.addAnnotationLevel(levelSlimDTO);
//                userDTO.addAnnotationLevel(bhaashikSpringRestClient.getModelMapper().map(levelDTO, BhaashikAnnotationLevelSlimDTO.class));
            }
        }        
...
//            userDTO.removeAnnotationLevel(bhaashikSpringRestClient.getModelMapper().map(levelDTO, BhaashikAnnotationLevelSlimDTO.class));
        }        
    ...
    private void saveAnnotationManagementInfoJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAnnotationManagementInfoJButtonActionPerformed
        try {
            ...
            {
                bhaashikSpringRestClient.saveAnnotationManagementUpdateInfo(annotationManagementUpdateInfo);
            }
            else
            {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        {
            Boolean exists = bhaashikSpringRestClient.doesUserExist(username);
            ...
            exists = bhaashikSpringRestClient.doesEmailExist(username);
            ...
            BhaashikUserDTO userDTO = BhaashikUserDTO.builder().username(username)
                    .password(password)
                    .emailAddress(email)
                    .firstName(firstName)
                    .lastName(lastName)
            ...
            BhaashikUserSlimDTO userSlimDTO = BhaashikUserSlimDTO.builder().username(username)
                    .password(password)
                    .emailAddress(email)
                    .firstName(firstName)
                    .lastName(lastName)
...
//            annotationManagementUpdateInfo.getAssignedUserLevels().put(userDTO.getUsername(), new ConcurrentLinkedHashMap<>());
    ...
    {
        String bhaashikRole = currentUser.getCurrentRoleName();
        
        if(bhaashikRole.equals(BhaashikRole.VIEWER) || bhaashikRole.equals(BhaashikRole.ANNOTATOR)
                || bhaashikRole.equals(BhaashikRole.VALIDATOR))
        {
    ...
    private void fillOrganisationsInfo()
    {
        Map<String, BhaashikOrganisationDTO> bhaashikOrganisationMap = null;
//        try {
//            bhaashikOrganisationMap = bhaashikSpringRestClient.getAllOrganisations();
            bhaashikOrganisationMap = annotationManagementUpdateInfo.getAllOrganisations();
//        }
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
        ...
        bhaashikOrganisationMap.entrySet().forEach(
                entry ->
                {
...
//        }
    ...
    {
        Map<String, BhaashikRoleDTO> roleMap = null;

        roleMap = annotationManagementUpdateInfo.getAllRoles();

//        try {
//            roleMap = bhaashikSpringRestClient.getAllRoles();
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
    ...
    {
        Map<String, BhaashikAnnotationLevelDTO> annotationLevelMap = null;

        annotationLevelMap = annotationManagementUpdateInfo.getAllLevels();

//        try {
//            annotationLevelMap = bhaashikSpringRestClient.getAllAnnotationLevels();
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
    ...
    private void fillUserRoleInfo(BhaashikUserDTO selectedUser)
    {
        if(selectedUser == null)
            return;;

        Map<String, BhaashikRoleSlimDTO> roleSlimMap = null;
//        Map<String, BhaashikRoleDTO> roleMap = null;

        Map<String, BhaashikRoleDTO> allRoleMap = annotationManagementUpdateInfo.getAllRoles();
...
//        try {
//            roleMap = bhaashikSpringRestClient.getUserRoles(selectedUser.getUsername());
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
    ...
    private void fillUserOrganisationInfo(BhaashikUserDTO selectedUser)
    {
        if(selectedUser == null)
            return;;

        Map<String, BhaashikOrganisationSlimDTO> bhaashikOrganisationSlimMap = null;
//        Map<String, BhaashikOrganisationDTO> bhaashikOrganisationMap = null;

        Map<String, BhaashikOrganisationDTO> allOrganisationMap = annotationManagementUpdateInfo.getAllOrganisations();
        bhaashikOrganisationSlimMap = annotationManagementUpdateInfo.getAllUsers().get(selectedUser.getUsername()).getOrganisations();
//        bhaashikOrganisationSlimMap = annotationManagementUpdateInfo.getAssignedUserOrganisations().get(selectedUser.getUsername());

//        try {
//            bhaashikOrganisationMap = bhaashikSpringRestClient.getUserOrganisations(selectedUser.getUsername());
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
        ...
        bhaashikOrganisationSlimMap.entrySet().forEach(
                entry -> 
                {  
                    if(entry.getValue() != null && !entry.getValue().isToBeDeleted())
                    {
    ...
    private void fillUserLangaugesInfo(BhaashikUserDTO selectedUser)
    {
        if(selectedUser == null)
            return;;

        Map<String, BhaashikResourceLanguageSlimDTO> bhaashikLanguagesSlimMap = null;
//        Map<String, BhaashikResourceLanguageDTO> bhaashikLanguagesMap = null;

        Map<String, BhaashikResourceLanguageDTO> allLanguagesMap = annotationManagementUpdateInfo.getAllLanguages();
        bhaashikLanguagesSlimMap = annotationManagementUpdateInfo.getAllUsers().get(selectedUser.getUsername()).getLanguages();
//        bhaashikLanguagesSlimMap = annotationManagementUpdateInfo.getAssignedUserLanguages().get(selectedUser.getUsername());

//        try {
//            bhaashikLanguagesMap = bhaashikSpringRestClient.getUserLanguages(selectedUser.getUsername());
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
        ...
        bhaashikLanguagesSlimMap.entrySet().forEach(
                entry -> 
                {
                    if(entry.getValue() != null && !entry.getValue().isToBeDeleted())
                    {
    ...
    private void fillAnnotationLevelInfo(BhaashikUserDTO selectedUser)
    {
        if(selectedUser == null)
            return;;

        Map<String, BhaashikAnnotationLevelSlimDTO> annotationLevelSlimMap = null;
//        Map<String, BhaashikAnnotationLevelDTO> annotationLevelMap = null;

        Map<String, BhaashikAnnotationLevelDTO> allLevelsMap = annotationManagementUpdateInfo.getAllLevels();
...
//        try {
//            annotationLevelMap = bhaashikSpringRestClient.getUserAnnotationLevels(selectedUser.getUsername());
//        } catch (JsonProcessingException e) {
//            throw new RuntimeException(e);
//        }
...
//            FileMonitor.getInstance().removeFileChangeListener(bhaashikBackup, textFile);
    ...
    private String validateAnnotationManagementUpdateInfo(BhaashikAnnotationManagementUpdateInfo annotationManagementUpdateInfo)
    {
...
//        mainJSplitPane.setLeftComponent(fileExplorerJPanel);
        ...
        remoteFileExplorerJPanel.sortTree();
    }
...
//            rmiFileSystem = (RMIFileSystemRI)registry.lookup("bhaashikRMIProtocol");
            bhaashikServerLauncher = (BhaashikServerLauncherRI)registry.lookup(LAUNCHER_LOGIN);
            authenticationEntry = (AuthenticationEntryRI)registry.lookup(AUTH_LOGIN);

            bhaashikLauncherSession = (BhaashikLauncherSessionRI)registry.lookup(LAUNCHER_SESSION);
        ...
        {        
            ...
            BhaashikMain.setConnected(connected);
    ...
    public boolean loginRemoteRMI()
    {
        ...
        try {
            ...
            launcherSessionId = bhaashikServerLauncher.login(userName, password.toCharArray());
            authenticationSessionId = authenticationEntry.login(userName, password.toCharArray());
            
            bhaashikMainServer = bhaashikLauncherSession.getBhaashikMainServerInstance(launcherSessionId);
//            authenticationSever = authenticationSession.getAuthenticationSeverInstance(authenticationSessionId);
            rmiFileSystem = bhaashikMainServer.getRMIFileSystem();
            userManagerRI = bhaashikMainServer.getUserManager();
            resourceManagerRI = bhaashikMainServer.getResourceManager();
...
//            sessionId = (UUID) authenticationSever.authenticateUser(userName, password);
        ...
        BhaashikMain.setLoggedIn(loggedIn);
    ...
    public boolean loginSpringWeb() throws JsonProcessingException {
        ...
        bhaashikSpringRestClient.authenticateUser(server, userName, password);
        currentUser = bhaashikSpringRestClient.getCurrentUser();
        
        annotationManagementUpdateInfo = bhaashikSpringRestClient.getAnnotationManagementUpdateInfo();
...
//            System.out.println("Shell Example: DONE");
            ...
            BhaashikMain.setConnected(connectionSuccessful);
            BhaashikMain.setLoggedIn(connectionSuccessful);
...
//        rootRemoteFileNode = RemoteFileNode.getRemoteFileNodeInstance(null, null, null, rmiFileSystem, RemoteFileNode.RMI_MODE);
        ...
        try{
            ...
            bhaashikSpringRestClient.listDirectories("", rootRemoteFileNode, charset);
            RemoteFileNode annotationDirNode = RMIUtils.getAnnotationDirNodeRMI(rootRemoteFileNode);
            ...
            {
                bhaashikSpringRestClient.cloneDirectory(annotationDirNode, false);
            }
        }
        catch(Exception e)
        {
    ...
    public void remoteDisconnect()
    {
        ...
        if(registry != null)
            try {
                registry.unbind("bhaashikRMIProtocol");
        } catch (RemoteException ex) {
            Logger.getLogger(BhaashikRemoteWorkJPanel.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NotBoundException ex) {
            Logger.getLogger(BhaashikRemoteWorkJPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public boolean downloadRemoteFile()
    {
        ...
        if(connectionMode == RemoteFileNode.RMI_MODE)
            ...
            cloneSuccess = bhaashikSpringRestClient.cloneFile(rootRemoteFileNode.getRemoteRMIFile(), true);
        else if(connectionMode == RemoteFileNode.SFTP_MODE)
...
//	((AnnotationClient) owner).setWorkJPanel(workJPanel);
    ...
    public void uploadFile(String localPath, ActionEvent evt)
    {
        try {
            ...
            else if(connectionMode == RemoteFileNode.SPRING_MODE)
            {
                ...
                bhaashikSpringRestClient.uploadFile(currentUser.getUsername(), remoteFile, true);
            }
        }
        catch(Exception ex)
        {
	...
	BhaashikRemoteWorkJPanel newContentPane = new BhaashikRemoteWorkJPanel();
