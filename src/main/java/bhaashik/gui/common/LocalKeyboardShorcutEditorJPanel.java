...
public class LocalKeyboardShorcutEditorJPanel extends javax.swing.JPanel implements JPanelDialog {
    ...
    public LocalKeyboardShorcutEditorJPanel(BhaashikTableModel shortcutTableModel) {
        initComponents();
        ...
        shortcutTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(shortcutTableModel, "eng::utf8");
    ...
    {
//        shortcutTableModel = BhaashikShortcutsData.getShortcutsTable(actions, customInputMap, customActionMap, actionsKeyMap);
...
//        }
    ...
    {
        BhaashikShortcutsData.readShortcuts(shortcutTableModel, actions, customInputMap, customActionMap, actionsKeyMap);
