...
//    public AuthenticationSever(BhaashikMainServer bhaashikMainServer) throws RemoteException
...
//        this.bhaashikMainServer = bhaashikMainServer;
        ...
        if (value.equals("aValue")) {
            BhaashikMainServer.getLogger().info("Retrieved the correct value! [" + value + "]");
        }
    }
    ...
    {
        org.slf4j.Logger log = BhaashikMainServer.getLogger();
