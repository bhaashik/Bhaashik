...
import bhaashik.server.dto.auth.model.domain.BhaashikUserDTO;

public class BhaashikSpringClientUtils {
    
    public static BhaashikSpringRestClient getBhaashikSpringRestClientInstance() throws IOException
    {
        BhaashikSpringRestClient bhaashikSpringRestClient = new BhaashikSpringRestClient();
        
        RestTemplate restTemplate = getRestTemplateInstance(bhaashikSpringRestClient);
        
        bhaashikSpringRestClient.setRestTemplate(restTemplate);

        bhaashikSpringRestClient.init();
        
        return bhaashikSpringRestClient;
    }

    public static RestTemplate getRestTemplateInstance(BhaashikSpringRestClient bhaashikSpringRestClient) {
        ...
        interceptors.add(new RestTemplateHeaderModifierInterceptor(bhaashikSpringRestClient));
...
//        );
    ...
    public static String buildClientAnnotationFolderPath(BhaashikUserDTO user)
    {
        String path = BhaashikSpringRestClient.SANCHAY_CONFIG_PROPERTIES.getProperty("CLIENT_ANNOTATION_FOLDER");
...
//        String value = entry.getValue();
    ...
    public static String getAbsolutePathOnClient(BhaashikUserDTO user, String relativePathOnServer)
    {
