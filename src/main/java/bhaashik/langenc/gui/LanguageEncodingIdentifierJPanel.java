 ...
 * @author  anil
 */
public class LanguageEncodingIdentifierJPanel extends javax.swing.JPanel implements JPanelDialog, BhaashikClient {
...
//        owner.setCursor(new Cursor((Cursor.WAIT_CURSOR)));
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(GlobalProperties.getIntlString("Bhaashik_Language_and_Encoding_Identifier"));
    ...
    private class LanguageEncodingIdentifierWorker extends SwingWorker {
        ...
        {
            if(owner !=null && owner instanceof BhaashikMain)
                ((BhaashikMain) owner).showConsole();
