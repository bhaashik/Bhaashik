...
//                System.out.println("Bhaashik path: " + path);
                ...
                BHAASHIK_HOME = path.substring(0, ind + ("Bhaashik").length());
...
//
//        return props.getPropertyValue(bhaashikResourceBundle.getString("SANCHAY_HOME"));
...
////        KeyValueProperties props = getProperties();
////
////        props.addProperty(bhaashikResourceBundle.getString("SANCHAY_HOME"), d);
//    }
    ...
    public static String getIntlString(String key)
    {
        if(bhaashikResourceBundle == null)
            bhaashikResourceBundle = ResourceBundle.getBundle("bhaashik");
//            bhaashikResourceBundle = ResourceBundle.getBundle("bhaashik.intl.bhaashik");
