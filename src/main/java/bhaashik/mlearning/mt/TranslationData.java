 ...
 * @author anil
 */
public class TranslationData implements Resource, BhaashikDOMElement {
    ...
    public org.dom4j.dom.DOMElement getDOMElement()
    {
        ...
        attribDOM = new DOMAttribute(new org.dom4j.QName("SourceLang"), "" + BhaashikLanguages.getLanguageName(srcLangEnc));
        domElement.add(attribDOM);

        attribDOM = new DOMAttribute(new org.dom4j.QName("TargetLang"), "" + BhaashikLanguages.getLanguageName(tgtLangEnc));
        domElement.add(attribDOM);
    ...
    public void readXML(Element domElement)
    {
        ...
        String le = BhaashikLanguages.getLangEncCode(attribDOM.getNodeValue(), charset);
        ...
        le = BhaashikLanguages.getLangEncCode(attribDOM.getNodeValue(), charset);
