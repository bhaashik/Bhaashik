...
import bhaashik.text.enc.conv.WX2UTF8;
import bhaashik.text.DictionaryFST;
...
//    protected String srcPath = "/home/anil/tmp/feature_based_code/neList.txt";
    ...
    protected BhaashikEncodingConverter bhaashikEncodingConverter;
...
//                    }
        ...
        bhaashikEncodingConverter = new WX2UTF8(tgtLangEnc);
        ...
        while (sgmItr.hasNext()) {
            ...
            for (int i = 0; i < sengments.length; i++) {
                if (phraseTranslationTable.getTgtPhrases(UtilityFunctions.getSpacedOutString(sengments[i])) == null || sengments[i].length() > 3) {
                    remove.put(segmentation, Integer.valueOf(1));
                    break;
                }
            }
        }
...
//      candidates.printTranslationCandidates(ps, false);
    ...
    public TranslationCandidates generateTransliterationCandidatesEDATM(String srcWrd, boolean prune, boolean onlyTheFirst)
    {
        ...
        ((TransliterationCandidates) translationCandidatesDATM).scoreTransliterationCandidates(charNGramLMImpl, false, bhaashikEncodingConverter, /*phoneticNGram */ phoneticNGram, phoneticFeatureNGramLM, false);
                ...
                while(tgtItr.hasNext())
                {
                    ...
                    else
                    {
                        ...
                        while(cndItr.hasNext())
                        {
                            ...
                            convCandidatePart = bhaashikEncodingConverter.convert(convCandidatePart);
...
//                System.gc();
        ...
        translationCandidates = convertEncodingOfCandidates(translationCandidates);
        ((TransliterationCandidates) translationCandidates).scoreTransliterationCandidates(charNGramLMImpl, false, bhaashikEncodingConverter, /*phoneticNGram*/ phoneticNGram, phoneticFeatureNGramLM, false);
...
//        if(phoneticNGram)
//        {
//            translationCandidates.scoreTransliterationCandidates(charNGramLMImpl, false, bhaashikEncodingConverter, /*phoneticNGram*/ true, phoneticFeatureNGramLM, true);
//            translationCandidates.normalizeScores(true, true);
...
//                {
//                    String tgtPhrase = (String) tgtItr.next();
//                    String tgtPhraseConverted = bhaashikEncodingConverter.convert(tgtPhrase.replaceAll(" ", ""));
//
...
////                                {
////                                    translationCandidates.sortTranslationCandidates(charNGramLMImpl, true, bhaashikEncodingConverter);
////                                    System.gc();
////                                }
//                            }
//                        }
...
//    }
    ...
    public TranslationCandidates convertEncodingOfCandidates(TranslationCandidates translationCandidates)
    {
        ...
        while(cndItr.hasNext())
        {
            ...
            convertedCandidate = bhaashikEncodingConverter.convert(convertedCandidate);
