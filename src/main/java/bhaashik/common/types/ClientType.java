...
//        }
    ...
    public static final ClientType SANCHAY_SSH_CLIENT = new ClientType("Bhaashik_SSH_Client", "SC", "BhaashikSSHClientJPanel", ServerType.RESOURCE_MANAGER, "bhaash.gui.clients");
    public static final ClientType SANCHAY_EDITOR = new ClientType(GlobalProperties.getIntlString("Bhaashik_Editor"), "SE", "TextEditorJPanel", ServerType.RESOURCE_MANAGER, "bhaash.text.editor.gui");
    public static final ClientType SANCHAY_RTF_EDITOR = new ClientType(GlobalProperties.getIntlString("Bhaashik_Rich_Text_Editor"), "RE", "RichTextEditorJPanel", ServerType.RESOURCE_MANAGER, "bhaash.text.editor.gui");
    public static final ClientType SANCHAY_SHELL = new ClientType("Bhaashik Shell", "SS", "BhaashikShellJPanel", ServerType.RESOURCE_MANAGER, "bhaash.gui.shell");
    public static final ClientType SANCHAY_HTML_BROWSER = new ClientType("Bhaashik HTML Browser", "SB", "HTMLBrowserJPanel", ServerType.RESOURCE_MANAGER, "bhaash.html.gui");
...
//    public static final ClientType SSF_CORPUS_ANALYZER = new ClientType("SSF Corpus Analyzer", "", "SSFCorpusAnalyzerJPanel", ServerType.SANCHAY_SERVER, "bhaash.corpus.ssf.gui");
//    public static final ClientType PARALLEL_CORPUS_MARKUP = new ClientType("Parallel Syntactic Annotation", "PS", "ParallelSyntacticAnnotationWorkJPanel",ServerType.SANCHAY_SERVER, "bhaash.corpus.parallel.gui");
//    public static final ClientType SANCHAY = new ClientType("BhaashikMain", "", ServerType.SANCHAY, "bhaash.clients");
...
//    public static final ClientType BLOG_LIST_CAPTURE = new ClientType("Blog List Capture", "", "BlogListCaptureJPanel", ServerType.SANCHAY_SERVER, "bhaash.corpus.blog");
//    public static final ClientType FILE_EXPLORER = new ClientType("File Explorer", "", "FileExplorerJPanel", ServerType.SANCHAY_SERVER, "bhaash.gui.common");
//    public static final ClientType FILE_MATCHER = new ClientType("File Matcher", "", "FileMatcherJPanel", ServerType.SANCHAY_SERVER, "bhaash.util.gui");
//    public static final ClientType FILTER_TRANSLATOR = new ClientType("Filter Traslator", "", "FilterTranslatorJPanel", ServerType.SANCHAY_SERVER, "bhaash.filters.gui");
//    public static final ClientType MNREAD = new ClientType("MNRead", "", "MNReadJPanel", ServerType.SANCHAY_SERVER, "bhaash.util.gui");
//    public static final ClientType SENTENCE_ALIGNER = new ClientType("Sentence Aligner", "", "SenAlignWorkJPanel", ServerType.SANCHAY_SERVER, "bhaash.corpus.parallel.aligner.sentence.gui");
...
//    public static final ClientType PARALLEL_MARKUP_ANALYZER = new ClientType("Parallel Markup Analyser", "", "ParallelMarkupAnalyzerJPanel", ServerType.SANCHAY_SERVER, "bhaash.marker.gui");
...
//    public static final ClientType PROPERTIES_MANAGER = new ClientType("Properties Manager", "", "PropertiesManagerJPanel", ServerType.SANCHAY_SERVER, "bhaash.properties.gui");
    ...
    public static final ClientType SANCHAY_CHARMAP = new ClientType("Bhaashik Charmap", "CM", "BhaashikCharmapJPanel", ServerType.RESOURCE_MANAGER, "bhaash.gui.common");
//    public static final ClientType SIMILARITY_MEASURE = new ClientType("Similarity Measure", "", "SimilarityMeasuresJPanel", ServerType.SANCHAY_SERVER, "bhaash.corpus.manager.gui");
//    public static final ClientType SPELL_CHECKER = new ClientType("Spell Checker", "", "SpellCheckerJPanel", ServerType.SANCHAY_SERVER, "bhaash.gui.common");
//    public static final ClientType TREE_EDITOR = new ClientType("Tree Editor", "", "BhaashikTreeJPanel", ServerType.SANCHAY_SERVER, "bhaash.tree.gui");
//    public static final ClientType XML_EDITOR = new ClientType("XML Editor", "", "BhaashikW3CXMLJPanel", ServerType.SANCHAY_SERVER, "bhaash.xml.gui");
