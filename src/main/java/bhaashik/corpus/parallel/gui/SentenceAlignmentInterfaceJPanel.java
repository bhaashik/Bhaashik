...
import bhaashik.corpus.parallel.aligner.DefaultSentenceAligner;
...
import bhaashik.table.gui.MultiLineCellEditor;
...
public class SentenceAlignmentInterfaceJPanel extends javax.swing.JPanel
    ...
    public SentenceAlignmentInterfaceJPanel(boolean sentenceAligner) {
        ...
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.SENTENCE_ALIGNMENT_INTERFACE.toString());
...
//        alignmentJTable.setTableHeader(null);
        ...
        UtilityFunctions.widthToFit(alignmentJTable, BhaashikJTable.ALIGNMENT_MODE);
...
//            columnView.setIsMetric(false);
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Bhaashik Setence Alignment JPanel");
