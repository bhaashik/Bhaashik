...
//        globalCorpusStatistics.loadGlobalData();
    ...
    {
        BhaashikTableModel wordFreqTable = new BhaashikTableModel(new String[]{"Word", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getWordFreq(), wordFreqTable, false);
        wordFreqTable.trimRows(false);

        BhaashikTableJPanel wordFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(wordFreqTable, langEnc, true);
        globalWordFreqJPanel.add(wordFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel posTagFreqTable = new BhaashikTableModel(new String[]{"POS Tag", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getPOSTagFreq(), posTagFreqTable, false);
        posTagFreqTable.trimRows(false);

        BhaashikTableJPanel posTagFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(posTagFreqTable, langEnc, true);
        globalPOSTagFreqJPanel.add(posTagFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel grelFreqTable = new BhaashikTableModel(new String[]{"Relation", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getGRelFreq(), grelFreqTable, false);
        grelFreqTable.trimRows(false);

        BhaashikTableJPanel grelFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(grelFreqTable, langEnc, true);
        globalGRrelFreqJPanel.add(grelFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel wordTagPairFreqTable = new BhaashikTableModel(new String[]{"Word-Tag Pair", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getWordTagFreq(), wordTagPairFreqTable, false);
        wordTagPairFreqTable.trimRows(false);

        BhaashikTableJPanel wordTagPairFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(wordTagPairFreqTable, langEnc, true);
        globalWordTagFreqJPanel.add(wordTagPairFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel chunkTagFreqTable = new BhaashikTableModel(new String[]{"Chunk Tag", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getChunkTagFreq(), chunkTagFreqTable, false);
        chunkTagFreqTable.trimRows(false);

        BhaashikTableJPanel chunkTagFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(chunkTagFreqTable, langEnc, true);
        globalChunkTagFreqJPanel.add(chunkTagFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel unchunkedWordFreqTable = new BhaashikTableModel(new String[]{"Unchunked Word", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getUnchunkedWordFreq(), unchunkedWordFreqTable, false);
        unchunkedWordFreqTable.trimRows(false);

        BhaashikTableJPanel unchunkedWordFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(unchunkedWordFreqTable, langEnc, true);
        globalUnchunkedWordFreqJPanel.add(unchunkedWordFreqTableJPanel, BorderLayout.CENTER);

        BhaashikTableModel chunkRelFreqTable = new BhaashikTableModel(new String[]{"Chunk Relation", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(globalCorpusStatistics.getChunkGRelFreq(), chunkRelFreqTable, false);
        chunkRelFreqTable.trimRows(false);

        BhaashikTableJPanel chunkRelFreqTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(chunkRelFreqTable, langEnc, true);
        ...
        BhaashikTableModel.mapToTable(tagsForWords, tagsForWordsTable, false);
        tagsForWordsTable.trimRows(false);

        BhaashikTableJPanel tagsForWordsTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(tagsForWordsTable, langEnc, true);
        ...
        tagsForWordsTableJPanel.getJTable().setDefaultEditor(String.class, new BhaashikTableCellEditor(langEnc, BhaashikTableCellEditor.MULTIPLE_ROW));
        ...
        BhaashikTableModel.mapToTable(wordsForTags, wordsForTagsTable, false);
        wordsForTagsTable.trimRows(false);

        BhaashikTableJPanel wordsForTagsTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(wordsForTagsTable, langEnc, true);
        ...
        wordsForTagsTableJPanel.getJTable().setDefaultEditor(String.class, new BhaashikTableCellEditor(langEnc, BhaashikTableCellEditor.MULTIPLE_ROW));
        ...
        BhaashikTableModel.mapToTable(chunksForRels, chunksForRelsTable, false);
        chunksForRelsTable.trimRows(false);

        BhaashikTableJPanel chunksForRelsTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(chunksForRelsTable, langEnc, true);
        ...
        chunksForRelsTableJPanel.getJTable().setDefaultEditor(String.class, new BhaashikTableCellEditor(langEnc, BhaashikTableCellEditor.MULTIPLE_ROW));
        ...
        BhaashikTableModel.mapToTable(relsForChunks, relsForChunksTable, false);
        relsForChunksTable.trimRows(false);

        BhaashikTableJPanel relsForChunksTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(relsForChunksTable, langEnc, true);
        ...
        relsForChunksTableJPanel.getJTable().setDefaultEditor(String.class, new BhaashikTableCellEditor(langEnc, BhaashikTableCellEditor.MULTIPLE_ROW));
    }

    private void loadLocalTabs()
    {
        BhaashikTableModel wordFreqTable = new BhaashikTableModel(new String[]{"Word", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getWordFreq(), wordFreqTable, false);
        wordFreqTable.trimRows(false);
        ...
        BhaashikTableModel posTagFreqTable = new BhaashikTableModel(new String[]{"POS Tag", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getPOSTagFreq(), posTagFreqTable, false);
        posTagFreqTable.trimRows(false);
        ...
        BhaashikTableModel grelFreqTable = new BhaashikTableModel(new String[]{"Relation", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getGRelFreq(), grelFreqTable, false);
        grelFreqTable.trimRows(false);
        ...
        BhaashikTableModel wordTagPairFreqTable = new BhaashikTableModel(new String[]{"Word-Tag Pair", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getWordTagFreq(), wordTagPairFreqTable, false);
        wordTagPairFreqTable.trimRows(false);
        ...
        BhaashikTableModel chunkTagFreqTable = new BhaashikTableModel(new String[]{"Chunk Tag", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getChunkTagFreq(), chunkTagFreqTable, false);
        chunkTagFreqTable.trimRows(false);
        ...
        BhaashikTableModel unchunkedWordFreqTable = new BhaashikTableModel(new String[]{"Unchunked Word", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getUnchunkedWordFreq(), unchunkedWordFreqTable, false);
        unchunkedWordFreqTable.trimRows(false);
        ...
        BhaashikTableModel chunkRelFreqTable = new BhaashikTableModel(new String[]{"Chunk Relation", "Frequency"}, 2);
        BhaashikTableModel.mapToTable(localCorpusStatistics.getChunkGRelFreq(), chunkRelFreqTable, false);
        chunkRelFreqTable.trimRows(false);
    ...
    protected void loadGlobalStats(SSFStory localSSFStory)
    {
        ...
        BhaashikTableModel dataTable = new BhaashikTableModel(new String[]{"Statistic", "Value"}, 16);
...
//        dataTable.setValueAt("Number of dependency relations", 15, ssfStory.countDependencyRelations());
        ...
        BhaashikTableJPanel dataTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(dataTable, langEnc);
    ...
    protected void loadWordFreq()
    {
        ...
        BhaashikTableModel dataTable = new BhaashikTableModel(new String[]{"Statistic", "Value"}, 2);
