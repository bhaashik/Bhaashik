...
import bhaashik.corpus.ssf.impl.SSFStoryConvertEncoding;
...
public class SyntacticAnnotationWorkJPanel extends javax.swing.JPanel
        implements WindowListener, WorkJPanelInterface, JPanelDialog,
...
//    private SSFPhraseJPanel ssfPhraseJPanel;
    ...
    private BhaashikRemoteWorkJPanel bhaashikRemoteWorkJPanel = null;
...
//            matches.setColumnIdentifiers(new String[]{"Sentence", "Matched Node", "Context", "Referred Node", "File", "Comment"});
    ...
    private void uploadJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uploadJButtonActionPerformed
        ...
        bhaashikRemoteWorkJPanel.uploadFile(localPath, evt);
...
//above I added later april
    ...
    public void openFileMode()
    {
        taskSetupJPanel = new SyntacticAnnotationTaskSetupJPanel(true, this);
        taskSetupJPanel.setOwner(owner);
        BhaashikJDialog openDialog = new BhaashikJDialog(owner, GlobalProperties.getIntlString("Bhaashik_Syntactic_Annotation_Task_Setup"), true, (JPanelDialog) taskSetupJPanel);
        openDialog.pack();
    ...
    {
        if(bhaashikRemoteWorkJPanel == null) {
            bhaashikRemoteWorkJPanel = BhaashikMain.getSSHClientJPanel();
        }

        bhaashikRemoteWorkJPanel.setWorkJPanel(this);

        bhaashikRemoteWorkJPanel.setOwner(owner);
        BhaashikJDialog openDialog = new BhaashikJDialog(owner, "Bhaashik_SSH_Client", true, (JPanelDialog) bhaashikRemoteWorkJPanel);
//            openDialog.pack();
        BhaashikGUIUtils.maximizeDialog(openDialog);
...
//            return;
        ...
        {
            int ret = JOptionPane.showConfirmDialog(this, "Would you like to save the document before proceeding?", GlobalProperties.getIntlString("Save?"), JOptionPane.YES_NO_OPTION);
...
//        initNavigationList();
    ...
    private void switchDNDView() {
        if(propbankModeJCheckBox.isSelected()) {
            ...
            try {
                if(mmRoot == null)
                    viewTreeJPanel = new BhaashikTreeViewerJPanel(sentence.getRoot(), sentence.getRoot().getCopy(), cfgToMMTreeMapping, BhaashikMutableTreeNode.DEPENDENCY_RELATIONS_MODE, langEnc, false);
                else
                    viewTreeJPanel = new BhaashikTreeViewerJPanel(sentence.getRoot(), mmRoot, cfgToMMTreeMapping, BhaashikMutableTreeNode.DEPENDENCY_RELATIONS_MODE, langEnc, false);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
...
//        ssfStory.clearHighlights();
        ...
        {
            JOptionPane.showMessageDialog(this, "Error in parsing the query: " + ssfQuery, GlobalProperties.getIntlString("Search_Results"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        if(matches == null)
        {
            JOptionPane.showMessageDialog(this, GlobalProperties.getIntlString("No_match_found."), GlobalProperties.getIntlString("Search_Results"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private void showSearchResults(BhaashikTableModel matches, String langEnc, int tcount) {
        ...
        matches.setValueAt(GlobalProperties.getIntlString("Total_:_"), 0, 0);
        matches.setValueAt(Integer.toString(tcount), 0, 1);
        
        BhaashikJDialog resultsJDialog = null;

        if(owner != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, BhaashikTableJPanel.DEFAULT_MODE);
        else if(dialog != null)
         resultsJDialog =DialogFactory.showTableDialog(dialog, GlobalProperties.getIntlString("Search_Results"), false, matches, langEnc, BhaashikTableJPanel.DEFAULT_MODE);
        ...
        //resultsJPanel.getJTable().setDefaultEditor(String.class,new BhaashikActionTableCellEditor(this, langEnc, "Search Results", BhaashikActionTableCellEditor.FIND_AND_NAVIGATE));
    ...
    private void showValSearchResults(BhaashikTableModel matches, String langEnc, int tcount) {
    ...
    private File[] getSelectedFiles() {
        ...
        BhaashikJDialog fsDialog = (BhaashikJDialog) DialogFactory.showFileSelectionDialog(owner, GlobalProperties.getIntlString("FileSelectionJPanel"), true, new File(curDir));
    ...
    public BhaashikTableModel getFindOptionsTable()
    {
        ...
        TableColumn textCol = tableJTable.getColumn(GlobalProperties.getIntlString("Text"));
        ...
        TableColumn attribNamesCol = tableJTable.getColumn(GlobalProperties.getIntlString("Attribute_Name"));
        ...
        TableColumn attribValsCol = tableJTable.getColumn(GlobalProperties.getIntlString("Attribute_Value"));
        attribValEditor.setEditable(true);
        attribValsCol.setCellEditor(new DefaultCellEditor(attribValEditor));

        BhaashikJDialog findDialog = new BhaashikJDialog(owner, GlobalProperties.getIntlString("Find"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
    ...
    public BhaashikTableModel getReplaceOptionsTable()
    {
        ...
        TableColumn newTagsCol = tableJTable.getColumn(GlobalProperties.getIntlString("New_Tag"));
        ...
        TableColumn newTextCol = tableJTable.getColumn(GlobalProperties.getIntlString("New_Text"));
        ...
        TableColumn newAttribNamesCol = tableJTable.getColumn(GlobalProperties.getIntlString("New_Name"));
        ...
        TableColumn createAttribCol = tableJTable.getColumn(GlobalProperties.getIntlString("Create_Attribute"));
        ...
        TableColumn newAttribValsCol = tableJTable.getColumn(GlobalProperties.getIntlString("New_Value"));
        newAttribValsCol.setCellEditor(new DefaultCellEditor(attribValEditor));

        BhaashikJDialog findDialog = new BhaashikJDialog(owner, GlobalProperties.getIntlString("Replace"), true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
...
//                    nlabelReplace, ntextReplace, attribReplace, valReplace, true, createAttrib);
            ...
            matches.insertRow(0);
            matches.setValueAt(GlobalProperties.getIntlString("Matches_-_") + (i + 1), 0, 0);
...
//                    cells[i][2] = ((SSFNode) n.getParent()).convertToBracketForm(1);
        ...
        BhaashikTableModel matches = new BhaashikTableModel(cells, new String[] {GlobalProperties.getIntlString("Sentence"), GlobalProperties.getIntlString("Matched_Text"), GlobalProperties.getIntlString("Context")});
...
//                }
                ...
                if(i == 0) {
                    ...
                    matches.addColumn(GlobalProperties.getIntlString("File"));
    ...
    private BhaashikTableModel getStats(SSFStory story) {
        ...
        BhaashikTableModel matches = new BhaashikTableModel(cells, new String[] {GlobalProperties.getIntlString("Sentences"), GlobalProperties.getIntlString("Chunks"), GlobalProperties.getIntlString("Words"), GlobalProperties.getIntlString("Characters")});
...
//    }
    ...
    private BhaashikTableModel getStatsInFiles() {
        ...
        if(selFiles != null && selFiles.length > 1) {
            ...
            matches.setValueAt(GlobalProperties.getIntlString("Total_(All_Files)"), 0, 4);
        } else {
...
//        owner.setCursor(new Cursor(Cursor.WAIT_CURSOR));
    ...
    public boolean editSSFText(boolean validateBeforeSave) {
        ...
        JDialog editTextDialog = new JDialog(this.getOwner(), GlobalProperties.getIntlString("Edit_Text"), true);
        
        textFile = kvTaskProps.getPropertyValue("SSFCorpusStoryFile");
        charset = kvTaskProps.getPropertyValue("SSFCorpusCharset");
        
        if(SimpleStoryImpl.getCorpusType(textFile, GlobalProperties.getIntlString("UTF-8")) == CorpusType.RAW
...
//        showSearchResults(matches, langEnc, 1);
    ...
    public void joinSentence(ActionEvent e)
    {
        if(currentPosition == ssfStory.countSentences() - 1) {
            JOptionPane.showMessageDialog(this, GlobalProperties.getIntlString("A_sentence_can_only_be_joined_with_the_next_sentence._You_are_at_the_last_sentence."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        currentComment = currentComment + GlobalProperties.getIntlString("._") + nextComment;
    ...
    public void splitSentence(ActionEvent e)
    {
        ...
        if (currentSelection != null)
        {
            ...
            if((currentNode.getParent() != null && currentNode.getParent().getParent() == null) == false) {
                JOptionPane.showMessageDialog(this, GlobalProperties.getIntlString("Wrong_selection_for_splitting_a_sentence."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
                return;
            }
...
//            save(null);
    ...
    public void joinFiles(ActionEvent e)
    {
        ...
        if(selFiles != null && selFiles.length > 1) {
            ...
            JOptionPane.showMessageDialog(parentComponent, GlobalProperties.getIntlString("Please_select_more_than_one_files_to_be_joined."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
        }
        ...
        try {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                String scharset = JOptionPane.showInputDialog(this, GlobalProperties.getIntlString("Please_enter_the_charset:"), GlobalProperties.getIntlString("UTF-8"));
                
                ((SSFStoryImpl) joinedStory).save(joinedStoryFile, scharset);
            }
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(parentComponent, GlobalProperties.getIntlString("Error_saving_the_joined_file."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        JOptionPane.showMessageDialog(parentComponent, selFiles.length + 
                "files joined into one file:\n" + joinedStoryFile, GlobalProperties.getIntlString("Joined_Files"), JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void transferTags(ActionEvent e)
    {
        JOptionPane.showMessageDialog(parentComponent, "The number of source and target files and of the sentences\n"
                ...
                + "there may be data loss.", GlobalProperties.getIntlString("Caution"), JOptionPane.INFORMATION_MESSAGE);
        ...
        if(srcFiles.length != tgtFiles.length) {
            JOptionPane.showMessageDialog(parentComponent, GlobalProperties.getIntlString("The_number_of_source_and_target_files_and_of_the_sentences_and_the_words_in_them_should_be_the_same."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, GlobalProperties.getIntlString("Are_you_sure_you_want_to_clear_some_annotation_this_sentence?"), GlobalProperties.getIntlString("Clear_Annotation_in_Sentence?"), JOptionPane.YES_NO_OPTION);
        ...
        if(owner != null)
            alDialog = SSFAnnotationLevelsJPanel.showDialog(owner, GlobalProperties.getIntlString("SSF_Annotation_Levels"), true);
        else if(dialog != null)
            alDialog = SSFAnnotationLevelsJPanel.showDialog(dialog, GlobalProperties.getIntlString("SSF_Annotation_Levels"), true);
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, GlobalProperties.getIntlString("Are_you_sure_you_want_to_clear_some_annotation_this_task?"), GlobalProperties.getIntlString("Clear_Annotation_in_Task?"), JOptionPane.YES_NO_OPTION);
    ...
    {
        int ret = JOptionPane.showConfirmDialog(this, GlobalProperties.getIntlString("Are_you_sure_you_want_to_reset_everything?"), GlobalProperties.getIntlString("Reset_All"), JOptionPane.YES_NO_OPTION);
    ...
    public void configure(SSFStory story)
    {
        ...
        try {
            ...
            if(dialog != null)
            {
                dialog.setTitle(GlobalProperties.getIntlString("Bhaashik:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
            else if(owner != null)
            {
                owner.setTitle(GlobalProperties.getIntlString("Bhaashik:_") + ClientType.SYNTACTIC_ANNOTATION.toString() + ": " + title);
            }
...
//                topJPanel.add(ssfPhraseJPanel, java.awt.BorderLayout.CENTER);
                ...
                if(commentsFile.exists()) {
                    try {
                        commentsPT = new PropertyTokens(commentsFile.getAbsolutePath(), GlobalProperties.getIntlString("UTF-8"));
                ...
                JOptionPane.showMessageDialog(parentComponent, GlobalProperties.getIntlString("Error_in_task_properties_for_the_task:_") + taskName + GlobalProperties.getIntlString("._Unable_to_load_any_sentences."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            }
        } catch(Exception e) {
...
//            taskList = owner.getTaskList();
        ...
        try {
            ...
            corpusType = SimpleStoryImpl.getCorpusType(textFile, GlobalProperties.getIntlString("UTF-8"));
            
            if(corpusType == CorpusType.RAW) {
                JOptionPane.showMessageDialog(parentComponent, "The task you have selected contains raw text. You\nnow have to make sure that each sentence is on\na separate line to ensure correct annotation.", GlobalProperties.getIntlString("Raw_Text"), JOptionPane.INFORMATION_MESSAGE);
                
                editSSFText(false);
                
                if(langEnc.equals("hin::utf8")) {
                    int ret = JOptionPane.showConfirmDialog(this, GlobalProperties.getIntlString("Would_like_the_text_to_be_POS_tagged?"), GlobalProperties.getIntlString("Perform_POS_Tagging?"), JOptionPane.YES_NO_OPTION);
                    
                    if(ret == JOptionPane.YES_OPTION)
                        annotate(MLCorpusConverter.TAG_FORMAT);
                    
                    ret = JOptionPane.showConfirmDialog(this, GlobalProperties.getIntlString("Would_like_the_text_to_be_chunked?"), GlobalProperties.getIntlString("Perform_Chunking?"), JOptionPane.YES_NO_OPTION);
    ...
    public void save(ActionEvent e) {
                ...
                || (!propbankMode && GlobalProperties.getClientModes().getPropertyValue("SYNTACTIC_ANNOTATION").equals("TASK_MODE")))
        {
            if(SelectTaskJPanel.isOwnTask(taskList, taskName) == false)
            {
                ...
                {
                    JOptionPane.showMessageDialog(parentComponent, "You can save this task only if you have claimed it first.", GlobalProperties.getIntlString("Error"),
...
//        dialog.setVisible(false);
    ...
    public void saveAs(ActionEvent e)
    {
        if(propbankMode)
        {
            JOptionPane.showMessageDialog(parentComponent, "Not available in the task mode.", GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        CorpusType selectedCorpusType = (CorpusType) JOptionPane.showInputDialog(this,
                GlobalProperties.getIntlString("Select_corpus_type_for_saving"), GlobalProperties.getIntlString("Corpus_Type"), JOptionPane.INFORMATION_MESSAGE, null,
    ...
    public void saveAs(CorpusType ctype) {
        ...
        if(textFileAs != null && !textFileAs.equals("") && !textFileAs.equals(GlobalProperties.getIntlString("Untitled"))) {
...
//            JOptionPane.showMessageDialog(parentComponent, bhaashik.GlobalProperties.getIntlString("XML_corpus_type_not_yet_implemented."), bhaashik.GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
    ...
    public String saveBracketFormAs(String curDir) {
        ...
        try {
            ...
            if(returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                String spaces = JOptionPane.showInputDialog(parentComponent, GlobalProperties.getIntlString("Please_enter_the_number_of_spaces_after_the_chunk_end:"), "5");
    ...
    protected void openInit(String path, String langEnc)
    {
        ...
        kvTaskProps.addProperty("TaskPropCharset", GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("SSFPropFile", GlobalProperties.resolveRelativePath("props/ssf-props.txt"));
        kvTaskProps.addProperty("SSFPropCharset", GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("FSPropFile", GlobalProperties.resolveRelativePath("props/fs-props.txt"));
        kvTaskProps.addProperty("FSPropCharset", GlobalProperties.getIntlString("UTF-8"));
        kvTaskProps.addProperty("MFeaturesFile", GlobalProperties.resolveRelativePath("props/fs-mandatory-attribs.txt"));
        kvTaskProps.addProperty("MFeaturesCharset", GlobalProperties.getIntlString("UTF-8"));
        ...
        kvTaskProps.addProperty("POSTagsCharset", GlobalProperties.getIntlString("UTF-8"));

        kvTaskProps.addProperty("PhraseNamesFile", GlobalProperties.resolveRelativePath("workspace/syn-annotation/phrase-names.txt"));
        kvTaskProps.addProperty("PhraseNamesCharset", GlobalProperties.getIntlString("UTF-8"));
    ...
    public void annotate(int type) {
        ...
        annotationMain.setMLTestPath(baseDir + GlobalProperties.getIntlString("/") + "crf-test.txt");
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(GlobalProperties.getIntlString("Bhaashik_Syntactic_Annotation"));
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            if(e.getType() == TableModelEvent.INSERT)
            {
                for (int i = 0; i < ccount; i++)
                {
                    ...
                    if(colName.equals(GlobalProperties.getIntlString("Create_Attribute")))
                        model.setValueAt(Boolean.FALSE, row, i);
                    else if(colName.equals(GlobalProperties.getIntlString("Tag")))
                        model.setValueAt(tag, row, i);
                    else if(colName.equals(GlobalProperties.getIntlString("Text")))
                    ...
                    if(replace)
                    {
                        if(colName.equals(GlobalProperties.getIntlString("New_Tag")))
                            model.setValueAt(UtilityFunctions.backFromExactMatchRegex(tag), row, i);
                        else if(colName.equals(GlobalProperties.getIntlString("New_Text")))
            ...
            else if(e.getType() == TableModelEvent.UPDATE && replace)
            {
                ...
                if(colName.equals(GlobalProperties.getIntlString("Tag")))
                {
                    tag = (String) model.getValueAt(row, column);
                    int newTagColIndex = model.getColumnIndex(GlobalProperties.getIntlString("New_Tag"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(tag), row, newTagColIndex);
                }
                else if(colName.equals(GlobalProperties.getIntlString("Text")))
                {
                    text = (String) model.getValueAt(row, column);
                    int newTextColIndex = model.getColumnIndex(GlobalProperties.getIntlString("New_Text"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(text), row, newTextColIndex);
                }
                else if(colName.equals(GlobalProperties.getIntlString("Attribute_Name")))
                {
                    String attrib = (String) model.getValueAt(row, column);
                    int newAttribColIndex = model.getColumnIndex(GlobalProperties.getIntlString("New_Name"));
                    model.setValueAt(UtilityFunctions.backFromExactMatchRegex(attrib), row, newAttribColIndex);
                }
                else if(colName.equals(GlobalProperties.getIntlString("Attribute_Value")))
                {
                    String val = (String) model.getValueAt(row, column);
                    int newValColIndex = model.getColumnIndex(GlobalProperties.getIntlString("New_Value"));
