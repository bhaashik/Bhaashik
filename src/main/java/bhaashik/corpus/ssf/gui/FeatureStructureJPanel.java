...
import bhaashik.gui.DataStructureJPanelInterface;
 ...
 * @author  anil
 */
public class FeatureStructureJPanel extends javax.swing.JPanel implements BhaashikClient,
...
//            featureValueIcon =  new ImageIcon(GlobalProperties.getHomeDirectory() + "/" + "images/color7-right.png");
        ...
        int cmds[] = new int[2];
//        cmds[0] = BhaashikTreeJPanel.EDIT_LABEL;
//        cmds[1] = BhaashikTreeJPanel.RESET_ALL_CMD;
//        cmds[2] = BhaashikTreeJPanel.CLEAR_ALL_CMD;
//        cmds[3] = BhaashikTreeJPanel.ADD_CHILD_CMD;
//        cmds[4] = BhaashikTreeJPanel.INSERT_CHILD_CMD;
//        cmds[5] = BhaashikTreeJPanel.DEL_SUBTREE_CMD;
//        cmds[6] = BhaashikTreeJPanel.MOVE_UP_CMD;
//        cmds[7] = BhaashikTreeJPanel.MOVE_DOWN_CMD;
        cmds[0] = TreeAction.EXPAND_ALL;
        cmds[1] = TreeAction.COLLAPSE_ALL;

        BhaashikTreeModel bhaashikTreeModel = new BhaashikTreeModel(featureStructuresCopy);
//        bhaashikTreeJPanel = new BhaashikTreeJPanel(bhaashikTreeModel,
//                new FSTreeCellRenderer(), cmds, BhaashikTreeJPanel.FS_MODE);
//        leftJPanel.add(bhaashikTreeJPanel, java.awt.BorderLayout.CENTER);
    }
...
//    }
    ...
    {
        bhaashikTreeJPanel.setModel(tm);
    }

    public BhaashikTreeModel getModel()
    {
        return (BhaashikTreeModel) bhaashikTreeJPanel.getModel();
    }
    
    public BhaashikTreeJPanel getBhaashikTreeJPanel()
    {
        return bhaashikTreeJPanel;
    }
