...
//        removeAllReturnNodes();
    ...
    public BhaashikTableModel query(SSFStory story, SSFQuery ssfQuery)
    {
...
//            JOptionPane.showMessageDialog(this, bhaashik.GlobalProperties.getIntlString("No_match_found."), bhaashik.GlobalProperties.getIntlString("Search_Results"), JOptionPane.INFORMATION_MESSAGE);
        ...
        BhaashikTableModel matchesTable = new BhaashikTableModel(new String[]{"Sentence", "Matched Node"}, 2);
        BhaashikTableModel.mapToTable(matches, matchesTable, true, false);
        ...
        BhaashikTableModel matches = null;
            ...
            while(itr.hasNext()) {
                ...
                if(i == 0) {
                    ...
                    matches.addColumn(GlobalProperties.getIntlString("Comment"));
