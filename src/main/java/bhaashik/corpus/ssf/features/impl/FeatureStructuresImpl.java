...
public class FeatureStructuresImpl extends BhaashikMutableTreeNode
        implements FeatureStructures, BhaashikDOMElement, Serializable
{
...
//            fss.readString(test);
//            ((BhaashikDOMElement) fss).readXML(test);
            ...
            ((BhaashikDOMElement) fss).printXML(System.out);
