...
public class NGramLMJPanel extends javax.swing.JPanel implements WindowListener, BhaashikClient, JPanelDialog {
    ...
    public BhaashikTableJPanel qOutputTJPanel;
...
//                System.out.println(ng.getString().replaceAll("@#&"," ") +"\t"+ ng.getFreq() +"\t"+ ng.getProb());
        ...
        qOutputTJPanel = BhaashikTableJPanel.createTableDefaultJPanel(qTableModel, getLangEnc());
        qOutputTJPanel.setSortable(true);
        qOutputTJPanel.showCommandButtons(false);
        //add(ngramQueryJPanel, java.awt.BorderLayout.CENTER);

        //UtilityFunctions.setComponentFont(qOutputTJPanel.getJTable(), BhaashikLanguages.getLangEncCode(language, encoding));
    ...
    private void languageJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_languageJComboBoxActionPerformed
        ...
        BhaashikLanguages.fillEncodings(encodings, BhaashikLanguages.getLanguageCode(language));
    ...
    {
        return BhaashikLanguages.getLangEncCode(language, encoding);
    }
