...
import bhaashik.text.ScriptStats;
 ...
 * @author  anil
 */
public class TextEditorJPanel extends javax.swing.JPanel implements WindowListener, FileDisplayer, BhaashikClient, JPanelDialog {
...
//        displayFileInBackground(new File(path), charset, e);
    ...
    public void setTitle(String t) {
        ...
        String fullTitle = GlobalProperties.getIntlString("Bhaashik:_") + ClientType.SANCHAY_EDITOR.toString() + GlobalProperties.getIntlString(":_") + title;
...
//    }
    ...
    public static String switchLanguageStatic(Component parent) {
        ...
        if(switching)
            initLang = BhaashikLanguages.getLanguageName( ((TextEditorJPanel) parent).langEnc );
    ...
    protected static String switchEncodingStatic(Component parent, String leCode, EventObject e) {
        ...
        if(switching)
            initEnc = BhaashikLanguages.getEncodingName( ((TextEditorJPanel) parent).langEnc );
        
        String currentLanguage = BhaashikLanguages.getLanguageName( ((TextEditorJPanel) parent).langEnc );
...
//                "." + newline);
    ...
    public void switchInputMethod(EventObject e) {
        ...
        if(im != null)
            BhaashikLanguages.changeInputMethod(textJTextArea, im);
    }
...
//        System.out.println("Input method selected: " + imc.selectInputMethod(new Locale("hi", "in", "Inscript")));
        ...
        if(selectedLanguage == null || selectedLanguage .equals("") == true)
            ...
            newContentPane = new TextEditorJPanel(BhaashikLanguages.getLangEncCode(selectedLanguage), null, null, DEFAULT_MODE);
        }
