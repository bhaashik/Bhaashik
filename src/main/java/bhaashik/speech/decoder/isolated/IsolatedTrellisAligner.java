...
package bhaashik.speech.decoder.isolated;
...
import bhaashik.matrix.SparseMatrixDouble;
import bhaashik.speech.common.TrellisString;
import bhaashik.speech.common.TwoByTwoBead;
import bhaashik.text.spell.DictionaryFSTExt;
import bhaashik.text.spell.PhoneticModelOfScripts;
import bhaashik.util.MathUtilFunctions;
import bhaashik.mlearning.mt.NumberTranslator;
import bhaashik.mlearning.mt.SMTTransliterator;
...
public class IsolatedTrellisAligner {
    ...
    protected BhaashikTableModel srcWTTable;
    protected BhaashikTableModel tgtWTTable;
...
//        candidates.printTranslationCandidates(System.out, false);
	...
	public IsolatedTrellisAligner(BhaashikTableModel srcWTTable, BhaashikTableModel tgtWTTable)
	{
        this();
    ...
    public void setWordTypeTables(BhaashikTableModel srcWTTable, BhaashikTableModel tgtWTTable)
    {
...
//    }
    ...
    protected void findSurfaceMatches()
    {
        ...
        {
            words.put((String) tgtWTTable.getValueAt(i, 0), Long.valueOf(1));
        }
