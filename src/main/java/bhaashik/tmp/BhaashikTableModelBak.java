 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class BhaashikTableModelBak extends DefaultTableModel implements Resource, BhaashikDOMElement {
    ...
    /**
     * Table schema is represented by BhaashikTableModel itself.
    ...
    protected BhaashikTableModelBak schema;
    ...
    public BhaashikTableModelBak(DBConnection c, String tableName) {
        super();
    ...
    public BhaashikTableModelBak(String url, String tableName, String driverName, String user, String passwd)
    {
        super();
    ...
    public BhaashikTableModelBak(int rowCount, int columnCount) {
    ...
    public BhaashikTableModelBak(Object[][] data, Object[] columnNames) {
    ...
    public BhaashikTableModelBak(Object[] columnNames, int rowCount) {
    ...
    public BhaashikTableModelBak(Vector columnNames, int rowCount) {
        super(columnNames, rowCount);
    ...
    public BhaashikTableModelBak(ArrayList<String> columnNames, int rowCount) {
    ...
    public BhaashikTableModelBak(Vector data, Vector columnNames) {
        super(data, columnNames);
    ...
    public BhaashikTableModelBak(String f, String charset) throws FileNotFoundException, IOException
    {
	super();
    ...
    public BhaashikTableModelBak(String f, String charset, BhaashikTableModelBak sch) throws FileNotFoundException, IOException
    {
        super();
    ...
    public BhaashikTableModelBak(String f, String charset, String sf, String scharset) throws FileNotFoundException, IOException
    {
        super();

        schema = new BhaashikTableModelBak();
    ...
    public BhaashikTableModelBak(String charset, BhaashikTableModelBak sch) throws FileNotFoundException, IOException
    {
        super();
...
//            return super.getColumnCount();
    ...
    public BhaashikTableModelBak getSchema()
    {
        return schema;
    }
    
    public void setSchema(BhaashikTableModelBak s)
    {
//        if(getColumnCount() == 0)
//        {
            schema = s;
...
//                object = cls.newInstance();
                ...
                Logger.getLogger(BhaashikTableModelBak.class.getName()).log(Level.SEVERE, null, ex);
        ...
        while((line = lnReader.readLine()) != null)
        {
            if((!line.startsWith("#")) && line.equals("") == false)
            {
                ...
                if(line.startsWith(GlobalProperties.getIntlString("Schema::")))
                {
                    ...
                    setSchema(new BhaashikTableModelBak(splitstr[1], splitstr[2]));
                }
...
//                    }
    ...
    public static LinkedHashMap readMany(String f, String charset) throws FileNotFoundException, IOException
    {
        ...
        BhaashikTableModelBak tbl = null;
        String tblName = "";
        ...
        while((line = lnReader.readLine()) != null)
        {
            if((!line.startsWith("#")) && line.equals("") == false)
            {
                ...
                else if(line.startsWith(GlobalProperties.getIntlString("Schema::")))
                {
                    ...
                    tbl.setSchema(new BhaashikTableModelBak(splitstr[1], splitstr[2]));
                }
                else if(line.startsWith(GlobalProperties.getIntlString("Column_Names::")))
                {
                    splitstr = line.split("::");
    ...
    public static void printMany(ConcurrentLinkedHashMap tables, PrintStream ps)
    {
        ...
        for(int i = 0; i < count; i++)
        {
            ...
            BhaashikTableModelBak tbl = (BhaashikTableModelBak) tables.get(tblName);
    ...
    {
        BhaashikTableModelBak obj = null;

        String sfname = GlobalProperties.getHomeDirectory() + "/" + "BhaashikTable-tmp.tmp";
        ...
        try {
            ...
            obj = (BhaashikTableModelBak) is.readObject();
    ...
    public int copyRow(int row1, int colOffset1, BhaashikTableModelBak toTable, int row2, int colOffset2)
    {
    ...
    public int copyColumn(int col1, int rowOffset1, BhaashikTableModelBak toTable, int col2, int rowOffset2)
    {
    ...
    public static BhaashikTableModelBak mergeRows(Vector tables, boolean addTableNumbers)
    {
	int maxColCount = 0;
	int rowCount = 0;
	...
	{
	    int ccount = ((BhaashikTableModelBak) tables.get(i)).getColumnCount();
	    rowCount += ((BhaashikTableModelBak) tables.get(i)).getRowCount();
	    
	    if(maxColCount < ccount)
		maxColCount = ccount;
	}
	
	BhaashikTableModelBak mergedTable = new BhaashikTableModelBak(rowCount, maxColCount + add);

    rowCount = 0;

	for (int i = 0; i < tables.size(); i++)
	{
	    BhaashikTableModelBak tbl = ((BhaashikTableModelBak) tables.get(i));
    ...
    public static BhaashikTableModelBak mergeRows(Vector tables)
    {
	return mergeRows(tables, false);
    }
    
    public static BhaashikTableModelBak mergeColumns(Vector tables)
    {
	int maxRowCount = 0;
	int colCount = 0;
	...
	for (int i = 0; i < tables.size(); i++)
	{
	    int rcount = ((BhaashikTableModelBak) tables.get(i)).getRowCount();
	    colCount += ((BhaashikTableModelBak) tables.get(i)).getColumnCount();
	    
	    if(maxRowCount < rcount)
		maxRowCount = rcount;
	}
	
	BhaashikTableModelBak mergedTable = new BhaashikTableModelBak(maxRowCount, colCount);
    ...
    public DOMElement getDOMElement() {
        ...
        if(schema == null)
        {
            if(getColumnCount() > 0 && getColumnName(0).equals("") == false)
            {
                DOMElement domElementSchema = new DOMElement("BhaashikTableSchema");
    ...
    public static void mapToTable(Map map, BhaashikTableModelBak table, boolean reverse, boolean clear)
    {
    ...
    public static void mapToTable(Map map, BhaashikTableModelBak table, boolean clear)
    {
    ...
    public static void main(String[] args) {
        BhaashikTableModelBak st = null;
        
        try {
//            st = new BhaashikTableModel(GlobalProperties.getHomeDirectory() + "/" + "userData/userdata1.txt", GlobalProperties.getIntlString("UTF-8"));
            st = new BhaashikTableModelBak("/extra/work/questimate/tmp/fst/doc147b.GRAPH-1.post", "UTF-8");
            st.print(System.out);
        } catch (FileNotFoundException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
